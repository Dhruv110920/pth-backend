    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">VIHAAN LUG (SV)-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹6,258</span>
                    <span class="original-price" id="originalPrice">₹6,652.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Vihaan LUG (SV)‑D is a tube-type, heavy‑ply radial tyre crafted for light commercial vehicles (LCVs) and small trucks/buses operating in high-load pickup/delivery roles. Featuring a rugged lug-style tread, it offers exceptional load capacity, off-road durability, and mileage in stop-start and rural logistics applications.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Heavy-duty construction with high ply rating for superior load endurance. </li>
                        <li><i class="fas fa-check"></i> Deep lug tread profile optimized for grip and self-cleaning in muddy or unpaved terrain. </li>
                        <li><i class="fas fa-check"></i> Shock‑absorbing rubber compounds reduce casing fatigue and increase life during high-impact routes.</li>
                        <li><i class="fas fa-check"></i> Enhanced heat dissipation capability through newer ply technologies for cooler running under heavy use.</li>
                        <li><i class="fas fa-check"></i>Exceptionally high mileage from optimized wear zones and durable tread compound tailored to Indian roads. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2‑year standard manufacturer warranty on its LCV commercial tyres, including the Vihaan series. Warranty covers radial splits (unrelated to external damage), ply or bead separations, and premature tread wear. Claims are assessed on a pro‑rated basis, based on remaining tread depth and inspection at an authorized Apollo center. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '37',
        inventoryId: 37, // Links to inventory system tire ID
        name: 'VIHAAN LUG (SV)-D',
        brand: 'Apollo',
        price: 6258,
        originalPrice: 6652,
        category: 'high-performance',
        description: 'The Vihaan LUG (SV)‑D is a tube-type, heavy‑ply radial tyre crafted for light commercial vehicles (LCVs) and small trucks/buses operating in high-load pickup/delivery roles. Featuring a rugged lug-style tread, it offers exceptional load capacity, off-road durability, and mileage in stop-start and rural logistics applications. ',
        features: [
            'Heavy-duty construction with high ply rating for superior load endurance.',
            'Deep lug tread profile optimized for grip and self-cleaning in muddy or unpaved terrain.',
            'Shock‑absorbing rubber compounds reduce casing fatigue and increase life during high-impact routes. ',
            'Enhanced heat dissipation capability through newer ply technologies for cooler running under heavy use.',
            'Exceptionally high mileage from optimized wear zones and durable tread compound tailored to Indian roads.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
