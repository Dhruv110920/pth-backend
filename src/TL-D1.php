    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RA(N) TL-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹11,713</span>
                    <span class="original-price" id="originalPrice">₹12,271.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The EnduRace RA(N) TL‑D is a tubeless all‑axle radial tyre in the RA(N) series, optimized for truck and bus regional distribution use. It combines long-life ribbed tread with durable casing and low rolling resistance for fuel savings and uniform wear across steer and trailer positions. Commonly available in sizes like 215/75 R17.5 with high load indices suitable for Indian M&HCV fleets.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Ribbed sinusoidal tread pattern: Ensures directional stability, even wear and consistent performance on all axle positions.</li>
                        <li><i class="fas fa-check"></i> Reinforced casing construction: Offers up to 2.5× the durability standard, significantly increasing retread potential.</li>
                        <li><i class="fas fa-check"></i> High‑rubber slow‑wear compound: Delivers higher mileage and abrasion resistance while keeping rolling resistance low. </li>
                        <li><i class="fas fa-check"></i> Tubeless TL‑D construction: Eliminates tube-related failures, improves reliability and reduces maintenance in demanding operations.</li>
                        <li><i class="fas fa-check"></i>Wide load indexing: Available in sizes such as 215/75 R17.5 126/124 M—suitable for high-load applications in trucks and buses. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2-year manufacturer’s warranty across the EnduRace RA range, including TL‑D variants. Coverage encompasses radial splits (without visible impact), ply/bead failures, and manufacturing defects. Claims are pro‑rated based on remaining tread life and require inspection by authorized dealers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '33',
        inventoryId: 33, // Links to inventory system tire ID
        name: 'Endu Race RA(N) TL-D',
        brand: 'Apollo',
        price: 11713,
        originalPrice: 12271,
        category: 'high-performance',
        description: 'The EnduRace RA(N) TL‑D is a tubeless all‑axle radial tyre in the RA(N) series, optimized for truck and bus regional distribution use. It combines long-life ribbed tread with durable casing and low rolling resistance for fuel savings and uniform wear across steer and trailer positions. Commonly available in sizes like 215/75 R17.5 with high load indices suitable for Indian M&HCV fleets.',
        features: [
            'Ribbed sinusoidal tread pattern: Ensures directional stability, even wear and consistent performance on all axle positions. ',
            'Reinforced casing construction: Offers up to 2.5× the durability standard, significantly increasing retread potential.',
            'High‑rubber slow‑wear compound: Delivers higher mileage and abrasion resistance while keeping rolling resistance low. ',
            'Tubeless TL‑D construction: Eliminates tube-related failures, improves reliability and reduces maintenance in demanding operations. ',
            'EWide load indexing: Available in sizes such as 215/75 R17.5 126/124 M—suitable for high-load applications in trucks and buses.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
