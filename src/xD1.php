        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="D.png.webp" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">X Multi Energy D</h1>
                <p class="product-brand" id="productBrand">Michelin</p>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹24,062</span>
                    <span class="original-price" id="originalPrice">₹25,181.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The Michelin X Multi Energy D is a tubeless radial drive tyre engineered for regional and long-haul commercial operations in India. It balances outstanding mileage, fuel efficiency, and retread potential, using advanced compounds and casing technologies optimized for Indian trucking conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Dual Energy Compound tread: Balances fuel-saving performance on top and durability underneath to reduce internal heat and improve lifespan.</li>
                        <li><i class="fas fa-check"></i>Matrix siping & Sipe Saver tech: Full-depth, interlocking sipes plus stress-relief teardrop shapes on shoulders to enhance traction and prevent tearing. </li>
                        <li><i class="fas fa-check"></i>Powercoil, Duracoil & Infinicoil casing: Advanced layers offer superior bead strength, crown stability, and retreadability.</li>
                        <li><i class="fas fa-check"></i>Low rolling resistance design: Helps deliver up to 8% fuel savings compared to competing models, as recognized by India's 4-star BEE label. </li>
                        <li><i class="fas fa-check"></i>All-weather and long-haul reliability: Wider footprint, uniform wear technology, and enhanced grip capability support somany-season performance.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Michelin’s commercial truck tyres—including the X Multi Energy D—typically come with a 2-year manufacturer warranty in India. It covers defects in material or workmanship (like casing failures or tread separation). Claims are handled on a pro‑rata basis, based on remaining usable tread life. Physical damage, misuse, or improper maintenance are not covered.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '66',
        inventoryId: 66, // Links to inventory system tire ID
        name: 'X Multi Energy D',
        brand: 'Michelin',
        price: 24062,
        originalPrice: 25181,
        category: 'high-performance',
        description: 'The Michelin X Multi Energy D is a tubeless radial drive tyre engineered for regional and long-haul commercial operations in India. It balances outstanding mileage, fuel efficiency, and retread potential, using advanced compounds and casing technologies optimized for Indian trucking conditions.',
        features: [
            'Dual Energy Compound tread: Balances fuel-saving performance on top and durability underneath to reduce internal heat and improve lifespan.',
            'Matrix siping & Sipe Saver tech: Full-depth, interlocking sipes plus stress-relief teardrop shapes on shoulders to enhance traction and prevent tearing.',
            'Matrix siping & Sipe Saver tech: Full-depth, interlocking sipes plus stress-relief teardrop shapes on shoulders to enhance traction and prevent tearing.',
            'Low rolling resistance design: Helps deliver up to 8% fuel savings compared to competing models, as recognized by India 4-star BEE label.',
            'All-weather and long-haul reliability: Wider footprint, uniform wear technology, and enhanced grip capability support somany-season performance.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
...
function goToShop() { 
    ...
    setTimeout(() => {
        window.location.href = 'michlen1.php';
    }, 500);
}
