    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">XT 100 HD-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹15,748</span>
                    <span class="original-price" id="originalPrice">₹16,426.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
              The Apollo XT‑100 HD‑D is a heavy-duty cross‑ply lug-pattern drive tyre tailored for regional haulage and mixed-route applications. It combines rugged casing strength with high tread volume to deliver superior load capacity, mileage, and retread potential—supported by Apollo’s enhanced thermal management technologies.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Modular Matrix Tread (MMT): Reinforced lug pattern with high tread volume ensures excellent traction and slow, even wear.</li>
                        <li><i class="fas fa-check"></i>Heavy-duty casing: High-strength nylon fabric in the casing provides top-tier durability and load-carrying performance. </li>
                        <li><i class="fas fa-check"></i>HEART technology (Heat Ageing Resistant Compound + Tyre Cavity design): Reduces heat buildup, allowing cooler running and enhanced casing life.</li>
                        <li><i class="fas fa-check"></i> Excellent mileage potential: High rubber mass and optimized MMT design champion longest-in-segment mileage.</li>
                        <li><i class="fas fa-check"></i>Superior retreadability: Durable casing with residual structure supports multiple retread cycles, lowering lifetime costs.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The XT‑100 HD‑D comes with Apollo’s 2‑year standard manufacturer warranty, covering defects like radial splits (without visible external damage), ply or bead failures, and premature tread wear. Claims are assessed on a pro‑rated basis, contingent on inspection at authorized centres.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '57',
        inventoryId: 57, // Links to inventory system tire ID
        name: 'XT 100 HD-D',
        brand: 'Apollo',
        price: 15748,
        originalPrice: 16426,
        category: 'high-performance',
        description: 'The Apollo XT‑100 HD‑D is a heavy-duty cross‑ply lug-pattern drive tyre tailored for regional haulage and mixed-route applications. It combines rugged casing strength with high tread volume to deliver superior load capacity, mileage, and retread potential—supported by Apollo’s enhanced thermal management technologies.',
        features: [
            'Modular Matrix Tread (MMT): Reinforced lug pattern with high tread volume ensures excellent traction and slow, even wear.',
            'Heavy-duty casing: High-strength nylon fabric in the casing provides top-tier durability and load-carrying performance.',
            'HEART technology (Heat Ageing Resistant Compound + Tyre Cavity design): Reduces heat buildup, allowing cooler running and enhanced casing life.',
            'Excellent mileage potential: High rubber mass and optimized MMT design champion longest-in-segment mileage.',
            'Superior retreadability: Durable casing with residual structure supports multiple retread cycles, lowering lifetime costs. ' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
