        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="M725.jpg" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">M725</h1>
                <p class="product-brand" id="productBrand">Bridgestone</p>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,476</span>
                    <span class="original-price" id="originalPrice">₹22,781.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Bridgestone M725 is a premium radial tyre designed for drive axle applications, delivering excellent traction and durability in both regional and long-haul operations. 
                    Its deep tread and aggressive block pattern offer superior grip on wet and dry surfaces, while minimizing irregular wear.  
                    Built with robust casing construction, the M725 ensures long tyre life and is ideal for fleets prioritizing performance and reliability.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Ultra‑deep open‑shoulder tread (30–32 32nds) — Designed for maximum traction across wet and dry road surfaces while also extending treadwear life.</li>
                        <li><i class="fas fa-check"></i> Dome‑block lug contour design — Promotes even wear to help prevent irregular tread patterns and extend service life.</li>
                        <li><i class="fas fa-check"></i> Stone‑rejector features integrated into grooves — Helps prevent stones from lodging and damaging the casing, improving durability.</li>
                        <li><i class="fas fa-check"></i> Cap/base compound construction — Combines a cool‑running base compound for casing protection with a long‑wearing cap compound for better mileage and excellent retreadability.</li>
                        <li><i class="fas fa-check"></i> Commercial‑grade warranty support — Backed by Bridgestone’s truck tyre limited warranty, reflecting fleet‑level build quality and reliability.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The Bridgestone M725 tyre in India comes with a warranty of up to 5 years from the date of manufacture against manufacturing defects like tread separation or sidewall issues. It also includes a pro-rata unconditional warranty for up to 3 years or 60% tread wear, whichever comes first.n. 
                    Warranty claims are valid only if the tyre is purchased from an authorized Bridgestone dealer and properly registered. Damages from misuse, punctures, or overloading are not covered.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '3',
        inventoryId: 3, // Links to inventory system tire ID
        name: 'M725',
        brand: 'Bridgestone',
        price: 20476,
        originalPrice: 22781,
        category: 'high-performance',
        description: 'The Bridgestone M725 is a premium radial tyre designed for drive axle applications, delivering excellent traction and durability in both regional and long-haul operations. Its deep tread and aggressive block pattern offer superior grip on wet and dry surfaces, while minimizing irregular wear. Built with robust casing construction, the M725 ensures long tyre life and is ideal for fleets prioritizing performance and reliability.',
        features: [
            'Ultra‑deep open‑shoulder tread (30–32 32nds) — Designed for maximum traction across wet and dry road surfaces while also extending treadwear life.',
            'Dome‑block lug contour design — Promotes even wear to help prevent irregular tread patterns and extend service life.',
            'Stone‑rejector features integrated into grooves — Helps prevent stones from lodging and damaging the casing, improving durability.',
            'Cap/base compound construction — Combines a cool‑running base compound for casing protection with a long‑wearing cap compound for better mileage and excellent retreadability.',
            'Commercial‑grade warranty support — Backed by Bridgestone’s truck tyre limited warranty, reflecting fleet‑level build quality and reliability.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
...
function goToShop() { 
    ...
    setTimeout(() => {
        window.location.href = 'bridgestone1.php';
    }, 500);
}
