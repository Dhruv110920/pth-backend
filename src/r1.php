    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RA</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹15,391</span>
                    <span class="original-price" id="originalPrice">₹16,013.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   Apollo EnduRace RA is a robust all-position radial tyre designed for regional and highway applications. It delivers balanced performance with excellent traction, even wear, and high mileage. Suitable for Indian roads, it ensures stability and fuel efficiency under varied load conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High mileage due to optimized tread compound.</li>
                        <li><i class="fas fa-check"></i> Reinforced casing for better retreadability.</li>
                        <li><i class="fas fa-check"></i> Zig-zag grooves for improved traction and braking.</li>
                        <li><i class="fas fa-check"></i> Even tread wear for longer life.</li>
                        <li><i class="fas fa-check"></i> Strong sidewalls for enhanced durability.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>IApollo EnduRace RA comes with a company-backed warranty in India covering manufacturing defects, radial splits (without visible impact), bead issues, ply or chafer separations, and 50% or more tread wear. All claims are subject to Apollo’s inspection and standard warranty terms.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '28',
        inventoryId: 28, // Links to inventory system tire ID
        name: 'Endu Race RA',
        brand: 'Apollo',
        price: 15391,
        originalPrice: 16013,
        category: 'high-performance',
        description: 'Apollo EnduRace RA is a robust all-position radial tyre designed for regional and highway applications. It delivers balanced performance with excellent traction, even wear, and high mileage. Suitable for Indian roads, it ensures stability and fuel efficiency under varied load conditions.',
        features: [
            'High mileage due to optimized tread compound',
            'Reinforced casing for better retreadability.',
            'Zig-zag grooves for improved traction and braking.',
            'Even tread wear for longer life.',
            'Strong sidewalls for enhanced durability.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
