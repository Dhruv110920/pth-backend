        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="tdb120.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">BOSS TDB 120</h1>
                <p class="product-brand" id="productBrand">Ascenso</p>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹8,113</span>
                    <span class="original-price" id="originalPrice">₹9,322.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The Ascenso BOSS TDB 120 is a bias‑ply R‑1 rear‑axle tyre crafted for 2WD tractors, delivering superior traction and durability in field operations via its wider lug pattern that penetrates soil effectively. 
                   It features a strong nylon carcass and robust sidewall construction to resist external damage,
                  and a deep-tread design that enhances grip and ride comfort on both field and haulage use.

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Wider lug pattern with R‑1 tread – Designed to penetrate soil easily and provide excellent traction and self-cleaning in soft or uneven terrain. </li>
                        <li><i class="fas fa-check"></i> Strong nylon carcass – Enhances structural integrity under heavy loads and prevents premature tyre failure during demanding farm operations. </li>
                        <li><i class="fas fa-check"></i> Reinforced sidewall construction – Offers robust resistance to punctures, cuts, and external damage in rough agricultural conditions. </li>
                        <li><i class="fas fa-check"></i> Directional aggressive tread with high void ratio – Improves field-terrain grip, reduces slippage, and boosts efficiency across loose soil surfaces.</li>
                        <li><i class="fas fa-check"></i> Enhanced controllability & steering responsiveness – Maintains solid tire-ground contact for better vehicle control and operator comfort in haulage or traction-intensive tasks.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Ascenso provides a 5‑year limited warranty on its bias‑ply tyres—including the BOSS TDB 120—covering manufacturing defects only. The warranty is pro‑rated based on the tyre’s remaining tread depth and age, up to a maximum of 60 months from purchase. It excludes damage caused by cuts, punctures, improper mounting, misuse, or road hazards. Claims must be made through an authorized Ascenso dealer with valid proof of purchase and tyre inspection.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '13',
        inventoryId: 13, // Links to inventory system tire ID
        name: 'BOSS TDB 120',
        brand: 'Ascenso',
        price: 8113,
        originalPrice: 9322,
        category: 'high-performance',
        description: 'The Ascenso BOSS TDB 120 is a bias‑ply R‑1 rear‑axle tyre crafted for 2WD tractors, delivering superior traction and durability in field operations via its wider lug pattern that penetrates soil effectively. It features a strong nylon carcass and robust sidewall construction to resist external damage, and a deep-tread design that enhances grip and ride comfort on both field and haulage use.',
        features: [
            'Wider lug pattern with R‑1 tread – Designed to penetrate soil easily and provide excellent traction and self-cleaning in soft or uneven terrain.',
            'Strong nylon carcass – Enhances structural integrity under heavy loads and prevents premature tyre failure during demanding farm operations. ',
            'Reinforced sidewall construction – Offers robust resistance to punctures, cuts, and external damage in rough agricultural conditions.',
            'Directional aggressive tread with high void ratio – Improves field-terrain grip, reduces slippage, and boosts efficiency across loose soil surfaces.',
            'Enhanced controllability & steering responsiveness – Maintains solid tire-ground contact for better vehicle control and operator comfort in haulage or traction-intensive tasks.'
        ], 
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
...
function goToShop() { 
    ...
    setTimeout(() => {
        window.location.href = 'ascenso1.php';
    }, 500);
}
