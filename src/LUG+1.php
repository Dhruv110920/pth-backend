    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Vikrant Trak LUG+</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹13,906</span>
                    <span class="original-price" id="originalPrice">₹14,601.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
             Vikrant Trak LUG+ is a heavy-duty commercial tyre designed for high traction performance in tough and off-road applications. It offers durability, deep tread design, and robust casing, making it ideal for trucks and commercial vehicles operating on mixed terrains like rural, mining, or construction routes.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Deep tread design for extended mileage and better traction.</li>
                        <li><i class="fas fa-check"></i>Reinforced casing ensures enhanced load-carrying capacity. </li>
                        <li><i class="fas fa-check"></i>Robust shoulder blocks for improved stability and cornering.</li>
                        <li><i class="fas fa-check"></i>Cut and chip resistant compound for rough road durability.</li>
                        <li><i class="fas fa-check"></i>Retreadable casing allows for multiple life cycles, improving cost efficiency. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Covered under a 3-year warranty from the date of invoice or manufacture, whichever comes first. The warranty is valid for the original purchaser and applies to manufacturing defects only. Claims are settled on a pro-rata basis based on remaining tread depth. Physical damage, road hazards, or misuse are not covered.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '61',
        inventoryId: 61, // Links to inventory system tire ID
        name: 'Vikrant Trak LUG+',
        brand: 'JK',
        price: 13906,
        originalPrice: 14601,
        category: 'high-performance',
        description: 'Vikrant Trak LUG+ is a heavy-duty commercial tyre designed for high traction performance in tough and off-road applications. It offers durability, deep tread design, and robust casing, making it ideal for trucks and commercial vehicles operating on mixed terrains like rural, mining, or construction routes.',
        features: [
            'Deep tread design for extended mileage and better traction.',
            'Reinforced casing ensures enhanced load-carrying capacity.',
            'Robust shoulder blocks for improved stability and cornering.',
            'Cut and chip resistant compound for rough road durability.',
            'Retreadable casing allows for multiple life cycles, improving cost efficiency.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
