        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="MA.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Trax MA</h1>
                ...
                <p class="product-description" id="productDescription">
                  The Apollo EnduTrax MA is a mixed‑service steer/trailer radial tyre designed primarily for heavy‑duty tipper usage. Built for both on- and off‑road applications, it features cut‑and‑chip resistant compounds, stone ejectors, and robust construction to handle rough terrains while maintaining high uptime and vehicle control in infrastructure operations.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Cut‑and‑chip resistant compound with stone‑ejector design protects the casing in rugged conditions.</li>
                        <li><i class="fas fa-check"></i> Zig‑zag centre grooves plus wide shoulders deliver traction, steering control, and uniform wear.</li>
                        <li><i class="fas fa-check"></i> ACTO (+ reinforced bead) casing engineered for high torque and multiple retreads—delivering extended tyre life.</li>
                        <li><i class="fas fa-check"></i> Distributed block architecture & rounded tie‑bars ensure grip even on slush, mud, or gravel surfaces. </li>
                        <li><i class="fas fa-check"></i>Extra cushioning rubber (around 14% more under tread) increases impact resistance and durability.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2‑year manufacturer warranty on its commercial vehicle tyres, including the EnduTrax MA. Coverage includes defects such as radial splits (unrelated to visible impact), ply/bead separations, and material or manufacturing faults. Claims are evaluated pro‑rata and contingent on inspection at Apollo-authorized centres.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '25',
        inventoryId: 25, // Links to inventory system tire ID
        name: 'Endu Trax MA',
        brand: 'Apollo',
        price: 18672,
        originalPrice: 19393,
        category: 'high-performance',
        description: 'The Apollo EnduTrax MA is a mixed‑service steer/trailer radial tyre designed primarily for heavy‑duty tipper usage. Built for both on- and off‑road applications, it features cut‑and‑chip resistant compounds, stone ejectors, and robust construction to handle rough terrains while maintaining high uptime and vehicle control in infrastructure operations.',
        features: [
            'Cut‑and‑chip resistant compound with stone‑ejector design protects the casing in rugged conditions.',
            'Zig‑zag centre grooves plus wide shoulders deliver traction, steering control, and uniform wear.',
            'ACTO (+ reinforced bead) casing engineered for high torque and multiple retreads—delivering extended tyre life. ',
            'Distributed block architecture & rounded tie‑bars ensure grip even on slush, mud, or gravel surfaces. ',
            'Extra cushioning rubber (around 14% more under tread) increases impact resistance and durability.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
