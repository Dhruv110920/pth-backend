        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="lug.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">VIHAAN LUG-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹9,157</span>
                    <span class="original-price" id="originalPrice">₹9,638.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo Vihaan Lug (SV)‑D is a tube-type drive tyre designed specifically for small- and medium-class commercial vehicles (SCVs). Featuring a robust lug-pattern tread, it’s built to withstand heavy payloads and deliver consistent performance across long hauls on urban and inter-city routes. 
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Aggressive lug tread design offers superior traction and self-cleaning in challenging road surfaces.</li>
                        <li><i class="fas fa-check"></i> High ply tube construction ensures structural strength for heavy load endurance and resistance to deflection.</li>
                        <li><i class="fas fa-check"></i> Thermally robust compound, engineered for heat resistance under prolonged runs and heavy torque applications.</li>
                        <li><i class="fas fa-check"></i> Optimized tread rubber mass in wear-prone zones delivers uniform wear and enhances mileage.</li>
                        <li><i class="fas fa-check"></i>Enhanced durability for SCV fleets, combining strong load-carry capability with consistent long-distance performance.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo Tyres provides a 2‑year standard manufacturer’s warranty on the Vihaan series. The warranty covers radial splits (absent visible impact), ply or bead separations, and manufacturing defects. Claims are evaluated on a pro‑rated basis, subject to inspection at authorized channels.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '40',
        inventoryId: 40, // Links to inventory system tire ID
        name: 'VIHAAN LUG-D',
        brand: 'Apollo',
        price: 9157,
        originalPrice: 9638,
        category: 'high-performance',
        description: 'The Apollo Vihaan Lug (SV)‑D is a tube-type drive tyre designed specifically for small- and medium-class commercial vehicles (SCVs). Featuring a robust lug-pattern tread, it’s built to withstand heavy payloads and deliver consistent performance across long hauls on urban and inter-city routes.',
        features: [
            'Aggressive lug tread design offers superior traction and self-cleaning in challenging road surfaces.',
            'High ply tube construction ensures structural strength for heavy load endurance and resistance to deflection. ',
            'Thermally robust compound, engineered for heat resistance under prolonged runs and heavy torque applications.',
            'Optimized tread rubber mass in wear-prone zones delivers uniform wear and enhances mileage.',
            'Enhanced durability for SCV fleets, combining strong load-carry capability with consistent long-distance performance.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
