        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="m751hl.jpg" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">M751 HL</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,750</span>
                ...
                <p class="product-description" id="productDescription">
                   The Bridgestone M751HL is a high-performance radial tyre engineered for heavy-duty truck applications, offering superior durability and traction. 
                    Its robust tread design ensures long-lasting mileage and enhanced resistance to irregular wear. 
                     Ideal for regional and highway use, the M751HL delivers reliable performance under demanding load conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High Load Capacity – Specifically designed to handle heavy-duty truck loads efficiently.</li>
                        <li><i class="fas fa-check"></i> Durable Tread Design – Enhanced tread pattern resists irregular wear for extended tyre life.</li>
                        <li><i class="fas fa-check"></i> Excellent Traction – Provides strong grip on both dry and wet road surfaces.</li>
                        <li><i class="fas fa-check"></i> Fuel Efficiency – Optimized for lower rolling resistance, improving fuel economy.</li>
                        <li><i class="fas fa-check"></i> Ideal for Highway Use – Built for consistent performance in regional and long-haul transport operations.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Bead burst, ply end separation, chafer end separation, rim digging, radial split (without visible impact mark on tread), block tear, and cases with up to 50% tread wear are typically covered under Bridgestone’s standard manufacturing defect warranty, provided there is no external damage involved.n. 
                    Such issues are considered potential material or manufacturing faults and are eligible for claim within 5 years from the manufacturing date. However, all claims are subject to inspection and approval by an authorized Bridgestone representative.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        ...
        description: 'The Bridgestone M751HL is a high-performance radial tyre engineered for heavy-duty truck applications, offering superior durability and traction. Its robust tread design ensures long-lasting mileage and enhanced resistance to irregular wear. Ideal for regional and highway use, the M751HL delivers reliable performance under demanding load conditions.',
        features: [
            'High Load Capacity – Specifically designed to handle heavy-duty truck loads efficiently.',
            'Durable Tread Design – Enhanced tread pattern resists irregular wear for extended tyre life.',
            'Excellent Traction – Provides strong grip on both dry and wet road surfaces.',
            'Fuel Efficiency – Optimized for lower rolling resistance, improving fuel economy.',
            'Ideal for Highway Use – Built for consistent performance in regional and long-haul transport operations.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
