...
<div class="product-card" data-id="6" data-redirect="TS1.php" data-name="BOSS TS 10">
    ...
    <div class="product-price">₹3,112</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: BOSS TS 10 -->
                    <div class="product-card" data-id="7" data-redirect="s1.php" data-name="BOSS TS 10">
                        <div class="product-image">
                            <img src="ts-10.png" alt="BOSS TS 10" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹4,025</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 3: BOSS TS 10-->
                    <div class="product-card" data-id="8" data-redirect="t1.php" data-name="BOSS TS 10">
                        <div class="product-image">
                            <img src="ts-10.png" alt="BOSS TS 10" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹4,847</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 4: BOSS TD 16 -->
                    <div class="product-card" data-id="9" data-redirect="td-161.php" data-name="BOSS TD 16">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹15,724</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 5: BOSS TD 16 -->
                    <div class="product-card" data-id="10" data-redirect="d1.php" data-name="BOSS TD 16">
                        <div class="product-image">
                            <img src="td-16.png" alt="BOSS TD 16" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹18,695</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 6: BOSS TD 16-->
                    <div class="product-card" data-id="11" data-redirect="161.php" data-name="BOSS TD 16">
                        <div class="product-image">
                            <img src="td-16.png" alt="BOSS TD 16" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹23,497</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 7: TDB 120 -->
                    <div class="product-card" data-id="12" data-redirect="TDB1.php" data-name="TDB 120">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹5,236</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 8: TDB 120 -->
                    <div class="product-card" data-id="13" data-redirect="B1.php" data-name="TDB 120">
                        <div class="product-image">
                            <img src="tdb120.png" alt="TDB 120" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹8,113</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 9: TDB 120 -->
                    <div class="product-card" data-id="14" data-redirect="DB1.php" data-name="TDB 120">
                        <div class="product-image">
                            <img src="tdb120.png" alt="TDB 120" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹6,152</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 10: BOSS TR 20 -->
                    <div class="product-card" data-id="15" data-redirect="TR1.php" data-name="BOSS TR 20">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹9,582</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 11: BOSS TR 21 -->
                    <div class="product-card" data-id="16" data-redirect="211.php" data-name="BOSS TR 21">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹14,869</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
