        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="Z+.png.webp" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">X Multi Energy Z+</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹22,578</span>
                    <span class="original-price" id="originalPrice">₹23,667.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The Michelin X Multi Energy Z+ is a tubeless radial drive/steer tyre engineered for Indian long-haul and regional transport. It offers industry-leading fuel efficiency, excellent mileage, and low rolling resistance—making it ideal for fleet-heavy trucking operations in India.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Low rolling resistance: Provides up to 15% fuel savings compared to competitors in the same class.</li>
                        <li><i class="fas fa-check"></i>Regenion Technology with silica-rich compound, balancing fuel efficiency with strong mileage and wear resistance.</li>
                        <li><i class="fas fa-check"></i>Advanced casing technologies like Powercoil, Duracoil, and Infinicoil deliver greater durability, bead stability, and retread life.</li>
                        <li><i class="fas fa-check"></i>Versatile performance across on-highway, regional roads, and mixed terrain routes—including all-season traction benefits.</li>
                        <li><i class="fas fa-check"></i>Lower carbon footprint operation: Engineered for reduced CO₂ emissions while maintaining reliability on Indian load conditions.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Michelin tyres in India generally come with a 2-year standard manufacturer’s warranty, covering defects in material or workmanship such as casing separation or tread delamination. Claims are handled via pro‑rata adjustment based on remaining tread life. Note: fuel-efficiency gains noted above are independent of warranty coverage.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '65',
        inventoryId: 65, // Links to inventory system tire ID
        name: 'X Multi Energy Z+',
        brand: 'Michelin',
        price: 22578,
        originalPrice: 23667,
        category: 'high-performance',
        description: 'The Michelin X Multi Energy Z+ is a tubeless radial drive/steer tyre engineered for Indian long-haul and regional transport. It offers industry-leading fuel efficiency, excellent mileage, and low rolling resistance—making it ideal for fleet-heavy trucking operations in India.',
        features: [
            'Low rolling resistance: Provides up to 15% fuel savings compared to competitors in the same class.',
            'Regenion Technology with silica-rich compound, balancing fuel efficiency with strong mileage and wear resistance.',
            'Advanced casing technologies like Powercoil, Duracoil, and Infinicoil deliver greater durability, bead stability, and retread life.',
            'Versatile performance across on-highway, regional roads, and mixed terrain routes—including all-season traction benefits.',
            'Versatile performance across on-highway, regional roads, and mixed terrain routes—including all-season traction benefits.' 
        ],
        specifications: {
            loadIndex: '91-98',
