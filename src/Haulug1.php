        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="haulage.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Haulug X-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹14,508</span>
                    <span class="original-price" id="originalPrice">₹15,150.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
             The Apollo Haulug X‑D is a high-performance drive axle tyre crafted for regional haulage and logistics in mixed‑condition environments. Built with a “U”-lug tread pattern and reinforced construction, it delivers superior traction, braking stability, and load endurance across varied terrain.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Universal “U”-lug design ensures excellent braking performance and traction on multiple surfaces.</li>
                        <li><i class="fas fa-check"></i>Reinforced casing strength built to handle high loads and frequent cycling while supporting extended retread life.</li>
                        <li><i class="fas fa-check"></i>Robust tread rubber compound developed for slow-wear and resistance to abrasion across regional haul routes.</li>
                        <li><i class="fas fa-check"></i> FStable directional control provided by structured lug alignment, delivering safe handling under heavy loads.</li>
                        <li><i class="fas fa-check"></i>Lower rolling resistance, which helps reduce fuel costs per kilometre in regular logistics operations.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2‑year manufacturer’s warranty on this tyre. Coverage includes defects like radial splits (excluding visible external trauma), ply/bead separation, and premature wear. Claims are handled on a pro‑rated basis and depend on inspection at authorized Apollo centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '55',
        inventoryId: 55, // Links to inventory system tire ID
        name: 'Haulug X-D',
        brand: 'Apollo',
        price: 14508,
        originalPrice: 15150,
        category: 'high-performance',
        description: 'The Apollo Haulug X‑D is a high-performance drive axle tyre crafted for regional haulage and logistics in mixed‑condition environments. Built with a “U”-lug tread pattern and reinforced construction, it delivers superior traction, braking stability, and load endurance across varied terrain.',
        features: [
            'Universal “U”-lug design ensures excellent braking performance and traction on multiple surfaces.',
            'Reinforced casing strength built to handle high loads and frequent cycling while supporting extended retread life.',
            'Robust tread rubber compound developed for slow-wear and resistance to abrasion across regional haul routes.',
            'Stable directional control provided by structured lug alignment, delivering safe handling under heavy loads.',
            'Lower rolling resistance, which helps reduce fuel costs per kilometre in regular logistics operations.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
