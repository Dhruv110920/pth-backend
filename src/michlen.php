        ...
        <main>
            ...
            <section class="products-section" id="productsSection">
                ...
                <div class="products-grid" id="productsGrid">
                    ...
                    <!-- Product 1:X Multi Energy Z+ -->
<div class="product-card" data-id="65" data-redirect="Z+.php" data-name="X Multi Energy Z+">
    <div class="product-image">
        <img src="Z+.png.webp" alt="X Multi Energy Z+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
        <div class="product-image-placeholder" style="display: none;">🛞</div>
    </div>
    <div class="product-brand">Michelin</div>
    <div class="product-name">X Multi Energy Z+</div>
    <div class="product-specs">295/80 R 22.5</div>
    <div class="product-price">₹23,203</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: X Multi Energy D -->
                    <div class="product-card" data-id="66" data-redirect="xD.php" data-name="X Multi Energy D">
                        <div class="product-image">
                            <img src="D.png.webp" alt="X Multi Energy D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Michelin</div>
                        <div class="product-name">X Multi Energy D</div>
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹24,687</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    ...
                    <!-- Product 4:X Multi D+ -->
                    <div class="product-card" data-id="68" data-redirect="D+.php" data-name="X Multi D+">
                        <div class="product-image">
                            <img src="D+.png.webp" alt="X Multi D+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Michelin</div>
                        <div class="product-name">X Multi D+</div>
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹25,469</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
