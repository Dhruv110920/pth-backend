        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="R271.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">R271</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹19,852</span>
                    <span class="original-price" id="originalPrice">₹22,486.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Bridgestone R271 is a premium radial tyre designed for commercial trucks, offering excellent durability and performance on both highways and city roads.
                   Its robust tread design ensures enhanced grip and even wear, contributing to longer tyre life. With superior heat resistance and load-carrying capacity, 
                   the R271 delivers reliable performance under demanding conditions. Ideal for regional and urban transport, it ensures a smooth and stable ride.

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Durable Tread Design – Ensures even wear and extended tyre life.</li>
                        <li><i class="fas fa-check"></i> Heat Resistant Compound – Reduces heat buildup for better performance on long routes.</li>
                        <li><i class="fas fa-check"></i> High Load Capacity – Designed to handle heavy commercial loads efficiently.</li>
                        <li><i class="fas fa-check"></i> Excellent Traction – Provides strong grip on both wet and dry surfaces.</li>
                        <li><i class="fas fa-check"></i> Reinforced Sidewalls – Enhance resistance against cuts and impacts for urban driving.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The Bridgestone R271 tyre warranty in India covers various manufacturing defects and specific types of damage. These include 50% tread wear, radial split without visible impact marks on the tread, bead burst, and rib tear. It also includes chafer edge separation, rim digging, and rib-punch wear, ensuring comprehensive protection for commercial users under eligible conditions.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '2',
        inventoryId: 2, // Links to inventory system tire ID
        name: 'R271',
        brand: 'Bridgestone',
        price: 19852,
        originalPrice: 22486,
        category: 'high-performance',
        description: 'The Bridgestone R271 is a premium radial tyre designed for commercial trucks, offering excellent durability and performance on both highways and city roads. Its robust tread design ensures enhanced grip and even wear, contributing to longer tyre life. With superior heat resistance and load-carrying capacity, the R271 delivers reliable performance under demanding conditions. Ideal for regional and urban transport, it ensures a smooth and stable ride.',
        features: [
            'Durable Tread Design – Ensures even wear and extended tyre life.',
            'Heat Resistant Compound – Reduces heat buildup for better performance on long routes.',
            'High Load Capacity – Designed to handle heavy commercial loads efficiently.',
            'Excellent Traction – Provides strong grip on both wet and dry surfaces.',
            'Reinforced Sidewalls – Enhance resistance against cuts and impacts for urban driving.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
