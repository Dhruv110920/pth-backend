        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="ED.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race ED</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹18,945</span>
                    <span class="original-price" id="originalPrice">₹19,715.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The EnduRace ED is a drive-axle radial tyre designed for heavy-duty regional and long-haul truck and bus applications. It features a robust casing and tread structure optimized for higher strength and consistent mileage. Engineered for retreadability, it helps reduce long-term operational costs while ensuring reliable traction across mixed road surfaces.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Reinforced Casing Design – Built for high durability and enhanced load-bearing capacity in tough driving conditions.</li>
                        <li><i class="fas fa-check"></i> Deep Tread Pattern – Offers superior traction and extended mileage on regional and long-haul routes.</li>
                        <li><i class="fas fa-check"></i> Optimized Tread Compound – Improves wear resistance and reduces rolling resistance for better fuel efficiency.</li>
                        <li><i class="fas fa-check"></i> Stone Ejector Grooves – Prevent stone retention, helping to protect the casing and extend tyre life.</li>
                        <li><i class="fas fa-check"></i> Retreadable Construction – Designed for multiple retreads, lowering overall operating costs.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>In India, the EnduRace ED tyre is covered by Apollo’s standard limited warranty, which protects against manufacturing defects for up to 2 years from purchase or until the tyre reaches the tread wear indicator—whichever occurs first. If a tyre fails within this period and wear limit, the customer may receive a pro-rata credit or replacement based on remaining tread depth. To claim warranty, the tyre must be registered (often within 30 days of purchase) and brought in with the original invoice to an authorized Apollo dealer. Exclusions include damage from overloading, improper fitment, inflation issues, or external hazards.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '19',
        inventoryId: 19, // Links to inventory system tire ID
        name: 'Endu Race ED',
        brand: 'Apollo',
        price: 18945,
        originalPrice: 19715,
        category: 'high-performance',
        description: 'The EnduRace ED is a drive-axle radial tyre designed for heavy-duty regional and long-haul truck and bus applications. It features a robust casing and tread structure optimized for higher strength and consistent mileage. Engineered for retreadability, it helps reduce long-term operational costs while ensuring reliable traction across mixed road surfaces.',
        features: [
            'Reinforced Casing Design – Built for high durability and enhanced load-bearing capacity in tough driving conditions.',
            'Deep Tread Pattern – Offers superior traction and extended mileage on regional and long-haul routes.',
            'Optimized Tread Compound – Improves wear resistance and reduces rolling resistance for better fuel efficiency.',
            'Stone Ejector Grooves – Prevent stone retention, helping to protect the casing and extend tyre life.',
            'Retreadable Construction – Designed for multiple retreads, lowering overall operating costs.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
