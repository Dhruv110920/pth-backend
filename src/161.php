        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="td-16.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">BOSS TD 16</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹23,497</span>
                    <span class="original-price" id="originalPrice">₹26,102.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Ascenso BOSS TD 16 is an R‑1 bias‑ply rear-axle tyre tailored for mid-to-high HP tractors, ideal for both field work and haulage in Indian farming conditions . It features a dual-lug angle design with high inner volume, delivering superior traction, self-cleaning, and reduced lug shuffling thanks to a center tie-bar design .
                   Built with superior nylon construction and deep tread, it offers high load-carrying capacity, improved traction, and longer mileage .  
                  Additionally, a CCR (cut‑&‑chip resistance) compound enhances durability and puncture resistance in tough terrain .

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Dual‑lug angle design with high inner volume – Enhances traction and provides superb self‑cleaning in muddy field conditions.</li>
                        <li><i class="fas fa-check"></i> Center tie-bar with strong lug base – Minimizes lug shuffling while driving, improving stability and operator comfort. </li>
                        <li><i class="fas fa-check"></i> Superior nylon construction – Provides high load-carrying capacity and structural strength for demanding tractor operations. </li>
                        <li><i class="fas fa-check"></i> Deep tread pattern – Offers better performance across both field and haulage use, with improved mileage and tread life.</li>
                        <li><i class="fas fa-check"></i> CCR (Cut & Chip Resistance) compound – Enhances durability by reducing punctures and resisting cuts/chipping in rough terrain.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The Ascenso BOSS TD 16 tyre in India comes with a 5-year limited warranty covering only manufacturing defects. This warranty is pro-rated based on the remaining tread depth and age of the tyre, valid up to 60 months from the date of purchase. It does not cover damages caused by cuts, punctures, improper use, or road hazards. Claims must be made through an authorized Ascenso dealer with valid proof of purchase.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '11',
        inventoryId: 11, // Links to inventory system tire ID
        name: 'BOSS TD 16',
        brand: 'Ascenso',
        price: 23497,
        originalPrice: 26102,
        category: 'high-performance',
        description: 'The Ascenso BOSS TD 16 is an R‑1 bias‑ply rear-axle tyre tailored for mid-to-high HP tractors, ideal for both field work and haulage in Indian farming conditions . It features a dual-lug angle design with high inner volume, delivering superior traction, self-cleaning, and reduced lug shuffling thanks to a center tie-bar design . Built with superior nylon construction and deep tread, it offers high load-carrying capacity, improved traction, and longer mileage . Additionally, a CCR (cut‑&‑chip resistance) compound enhances durability and puncture resistance in tough terrain .',
        features: [
            'Dual‑lug angle design with high inner volume – Enhances traction and provides superb self‑cleaning in muddy field conditions.',
            'Center tie-bar with strong lug base – Minimizes lug shuffling while driving, improving stability and operator comfort.',
            'Superior nylon construction – Provides high load-carrying capacity and structural strength for demanding tractor operations.',
            'Deep tread pattern – Offers better performance across both field and haulage use, with improved mileage and tread life.',
            'CCR (Cut & Chip Resistance) compound – Enhances durability by reducing punctures and resisting cuts/chipping in rough terrain.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
