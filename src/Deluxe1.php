        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="deluxe.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Amar Deluxe X-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹13,565</span>
                    <span class="original-price" id="originalPrice">₹14,178.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
              The Amar Deluxe X‑D is a robust drive axle radial tyre crafted for mixed and regional haulage operations on trucks and buses. With a sinusoidal 5‑rib tread pattern and tie-bars, it delivers superior traction, higher durability, and efficient wear resistance—making it ideal for demanding load and road conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Sinusoidal 5‑rib pattern with tie‑bars enhances water evacuation, grip, and uniform wear across the footprint.</li>
                        <li><i class="fas fa-check"></i>Reinforced shoulder ribs improve lateral stability and structural integrity under heavy loading.</li>
                        <li><i class="fas fa-check"></i>High land contact area reduces footprint pressure, boosting traction and minimizing tread wear.</li>
                        <li><i class="fas fa-check"></i> Fuel-efficient performance, reducing rolling resistance and helping fleet operators lower fuel costs.</li>
                        <li><i class="fas fa-check"></i>Superior casing strength engineered for long life and multiple retreading cycles, enhancing operational value. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2-year standard manufacturer’s warranty on the Amar Deluxe X‑D tyre. This includes coverage for defects such as radial splits (not caused by visible external damage), ply or bead separation, and premature tread wear. Claims are assessed on a pro‑rated basis, following standard inspection procedures.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '53',
        inventoryId: 53, // Links to inventory system tire ID
        name: 'Amar Deluxe X-D',
        brand: 'Apollo',
        price: 13565,
        originalPrice: 14178,
        category: 'high-performance',
        description: 'The Amar Deluxe X‑D is a robust drive axle radial tyre crafted for mixed and regional haulage operations on trucks and buses. With a sinusoidal 5‑rib tread pattern and tie-bars, it delivers superior traction, higher durability, and efficient wear resistance—making it ideal for demanding load and road conditions.',
        features: [
            'Sinusoidal 5‑rib pattern with tie‑bars enhances water evacuation, grip, and uniform wear across the footprint.',
            'Reinforced shoulder ribs improve lateral stability and structural integrity under heavy loading.',
            'High land contact area reduces footprint pressure, boosting traction and minimizing tread wear.',
            'Fuel-efficient performance, reducing rolling resistance and helping fleet operators lower fuel costs.',
            'Superior casing strength engineered for long life and multiple retreading cycles, enhancing operational value.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
