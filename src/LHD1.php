        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="LHD.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Mile LHD</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,000</span>
                    <span class="original-price" id="originalPrice">₹20,761.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  EnduMile LHD is a long‑haul drive radial tyre by Apollo Tyres, crafted for rated‑load operations and high‑speed long-distance trucking. It delivers excellent mileage—claimed to be over 20% better than its predecessor—thanks to a ventilated, pyramid‑inspired block tread and high rubber volume. Built with CTO casing and Concussion Shield Technology (CST), it runs cooler and supports multiple retreading cycles.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Maximized rubber volume & ventilated block design: wider shoulder blocks and pyramid/twist-style blocks or hexagonal blocks dissipate heat and enhance mileage.</li>
                        <li><i class="fas fa-check"></i> Apollo Cord Tension Optimisation (CTO) casing ensures structural durability and superior retread life.</li>
                        <li><i class="fas fa-check"></i> Concussion Shield Technology (CST): engineered for cooler running at higher speeds, reducing heat buildup and improving overall tyre longevity.</li>
                        <li><i class="fas fa-check"></i> Groove protectors & notch design: keeps stones and debris out, minimizing drilling damage and retaining retreadability.</li>
                        <li><i class="fas fa-check"></i>Fuel-efficient tread compound, with fuel efficiency rated in A–B band, delivering ~3–4% reduced rolling resistance.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2‑year manufacturer’s warranty on its truck and bus radial tyres, including the EnduMile LHD. The warranty covers defects such as radial splits (without external impact), bead or ply separations, or manufacturing flaws. Claims are assessed on a pro‑rated basis after inspection.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '24',
        inventoryId: 24, // Links to inventory system tire ID
        name: 'Endu Mile LHD',
        brand: 'Apollo',
        price: 20000,
        originalPrice: 20761,
        category: 'high-performance',
        description: 'EnduMile LHD is a long‑haul drive radial tyre by Apollo Tyres, crafted for rated‑load operations and high‑speed long-distance trucking. It delivers excellent mileage—claimed to be over 20% better than its predecessor—thanks to a ventilated, pyramid‑inspired block tread and high rubber volume. Built with CTO casing and Concussion Shield Technology (CST), it runs cooler and supports multiple retreading cycles.',
        features: [
            'Maximized rubber volume & ventilated block design: wider shoulder blocks and pyramid/twist-style blocks or hexagonal blocks dissipate heat and enhance mileage.',
            'Apollo Cord Tension Optimisation (CTO) casing ensures structural durability and superior retread life.',
            'Concussion Shield Technology (CST): engineered for cooler running at higher speeds, reducing heat buildup and improving overall tyre longevity. ',
            'Groove protectors & notch design: keeps stones and debris out, minimizing drilling damage and retaining retreadability. ',
            'Fuel-efficient tread compound, with fuel efficiency rated in A–B band, delivering ~3–4% reduced rolling resistance.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
