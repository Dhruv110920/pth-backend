...
<body>
    ...
    <script>
        ...
        // Function to go home - redirects to frontage.php
        function goHome() {
            console.log('Redirecting to frontage.php from Home button');
        ...
        // Function to go to dashboard - redirects to frontage.php
        function goToDashboard() {
            console.log('Redirecting to frontage.php from Dashboard button');
            window.location.href = 'frontage.php';
            return false;
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (homeBtn) {
                homeBtn.addEventListener('click', function(e) {
                    ...
                    console.log('Home button clicked - redirecting to frontage.php');
                    window.location.href = 'frontage.php';
                });
            }
            ...
            if (dashboardBtn) {
                dashboardBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    e.stopImmediatePropagation();
                    console.log('Dashboard button clicked - redirecting to frontage.php');
                    window.location.href = 'frontage.php';
                });
            }
        });
        ...
        // Additional navigation override to ensure frontage.php redirect
        window.addEventListener('load', function() {
            // Force override any conflicting navigation after everything loads
            ...
            if (homeButton) {
                ...
                homeButton.onclick = function(e) {
                    e.preventDefault();
                    e.stopImmediatePropagation();
                    console.log('Home button - forcing navigation to frontage.php');
                    window.location.href = 'frontage.php';
                    return false;
                };
            }
            ...
            if (dashboardButton) {
                ...
                dashboardButton.onclick = function(e) {
                    e.preventDefault();
                    e.stopImmediatePropagation();
                    console.log('Dashboard button - forcing navigation to frontage.php');
                    window.location.href = 'frontage.php';
                    return false;
                };
            }
