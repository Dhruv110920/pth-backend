...
<body>
    <img data-src="large-image.jpg" 
     data-src-mobile="small-image.jpg" 
     data-src-tablet="medium-image.jpg">
        ...
        <main>
            ...
            <section class="products-section" id="productsSection">
                ...
                <div class="products-grid" id="productsGrid">
                    ...
                    <!-- Product 1: BOSS TS 10 -->
<div class="product-card" data-id="6" data-redirect="TS.php" data-name="BOSS TS 10">
    <div class="product-image">
        <img src="ts-10.png" alt="BOSS TS 10" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
        <div class="product-image-placeholder" style="display: none;">🛞</div>
    </div>
    <div class="product-brand">Ascenso</div>
    <div class="product-name">BOSS TS 10</div>
    <div class="product-specs">6.00-16</div>
    <div class="product-price">₹3,110</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: BOSS TS 10 -->
                    <div class="product-card" data-id="7" data-redirect="s.php" data-name="BOSS TS 10">
                        <div class="product-image">
                            <img src="ts-10.png" alt="BOSS TS 10" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TS 10</div>
                        <div class="product-specs">6.50-16</div>
                        <div class="product-price">₹4,282</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 3: BOSS TS 10-->
                    <div class="product-card" data-id="8" data-redirect="t.php" data-name="BOSS TS 10">
                        <div class="product-image">
                            <img src="ts-10.png" alt="BOSS TS 10" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TS 10</div>
                        <div class="product-specs">7.50-16</div>
                        <div class="product-price">₹5,157</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 4: BOSS TD 16 -->
                    <div class="product-card" data-id="9" data-redirect="td-16.php" data-name="BOSS TD 16">
                        <div class="product-image">
                            <img src="td-16.png" alt="BOSS TD 16" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TD 16</div>
                        <div class="product-specs">13.6-28</div>
                        <div class="product-price">₹17,436</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 5: BOSS TD 16 -->
                    <div class="product-card" data-id="10" data-redirect="d.php" data-name="BOSS TD 16">
                        <div class="product-image">
                            <img src="td-16.png" alt="BOSS TD 16" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TD 16</div>
                        <div class="product-specs">14.9-28</div>
                        <div class="product-price">₹20,430</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 6: BOSS TD 16-->
                    <div class="product-card" data-id="11" data-redirect="16.php" data-name="BOSS TD 16">
                        <div class="product-image">
                            <img src="td-16.png" alt="BOSS TD 16" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TD 16</div>
                        <div class="product-specs">16.9-28</div>
                        <div class="product-price">₹24,169</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 7: TDB 120 -->
                    <div class="product-card" data-id="12" data-redirect="TDB.php" data-name="TDB 120">
                        <div class="product-image">
                            <img src="tdb120.png" alt="TDB 120" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">TDB 120</div>
                        <div class="product-specs">8.00-18 HD</div>
                        <div class="product-price">₹5,570</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 8: TDB 120 -->
                    <div class="product-card" data-id="13" data-redirect="tDB.php" data-name="TDB 120">
                        <div class="product-image">
                            <img src="tdb120.png" alt="TDB 120" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">TDB 120</div>
                        <div class="product-specs">9.5-24</div>
                        <div class="product-price">₹8,632</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 9: TDB 120 -->
                    <div class="product-card" data-id="14" data-redirect="TDb.php" data-name="TDB 120">
                        <div class="product-image">
                            <img src="tdb120.png" alt="TDB 120" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">TDB 120</div>
                        <div class="product-specs">8.3-32</div>
                        <div class="product-price">₹6,546</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 10: BOSS TR 20 -->
                    <div class="product-card" data-id="15" data-redirect="TR.php" data-name="BOSS TR 20">
                        <div class="product-image">
                            <img src="tr20.png" alt="BOSS TR 20" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TR 20</div>
                        <div class="product-specs">9.00-16</div>
                        <div class="product-price">₹10,194</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 11: BOSS TR 21 -->
                    <div class="product-card" data-id="16" data-redirect="21.php" data-name="BOSS TR 21">
                        <div class="product-image">
                            <img src="tr21.png" alt="BOSS TR 21" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Ascenso</div>
                        <div class="product-name">BOSS TR 21</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹15,818</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    
                   <img data-src="image-url.jpg" loading="lazy" alt="Product name">
                </div>
            </section>
        </main>
    </div>
...
<script src="path/to/fast-loading.js"></script>
<script src="path/to/user-detector.js"></script>
    <script>
// Product Page Stock Control System - Fixed to sync with inventory system
class ProductStockController {
    ...
    // Load stock data from sessionStorage (matching the inventory system)
    loadStockData() {
        // Try sessionStorage first (matches inventory system), then localStorage as fallback
    ...
    getStockStatus() {
        ...
        if (stock <= 10) return { class: 'low-stock', text: `Only ${stock} left!`, color: '#ff8c00' };
    ...
    validateQuantity(requestedQty) {
        ...
        if (!this.isInStock()) {
            this.showStockAlert('This item is currently out of stock.', 'error');
            return false;
        }

        if (requestedQty > currentStock) {
            this.showStockAlert(`Only ${currentStock} units available. Please reduce quantity.`, 'warning');
            return false;
        }
    ...
    listenForStockUpdates() {
        ...
        // Poll for stock updates every 5 seconds (more frequent for better sync)
        this.stockUpdateInterval = setInterval(() => {
            const newStockData = this.loadStockData();
            if (JSON.stringify(newStockData) !== JSON.stringify(this.stockData)) {
                console.log('Stock data changed, updating display...');
    ...
    setupFormValidation() {
        ...
        quantityInputs.forEach(input => {
            input.addEventListener('change', (e) => {
                ...
                if (value > this.getCurrentStock()) {
                    e.target.value = this.getCurrentStock();
                    this.showStockAlert(`Maximum available quantity is ${this.getCurrentStock()}`, 'warning');
                }
            });
        });
    }
...
// Fast Loading JavaScript for Product Pages
// Add this script to your existing HTML page
...
(function() {
    ...
    // 2. Progressive Product Loading
    function initProgressiveLoading() {
        const productCards = document.querySelectorAll('.product-card, .product-item, .product, [class*="product"]');
    ...
    // 4. Optimize Images Based on Screen Size
    function optimizeImageSizes() {
        const images = document.querySelectorAll('img');
        const screenWidth = window.innerWidth;
        
        images.forEach(img => {
            if (img.dataset.srcMobile && screenWidth < 768) {
                img.dataset.src = img.dataset.srcMobile;
            } else if (img.dataset.srcTablet && screenWidth < 1024) {
                img.dataset.src = img.dataset.srcTablet;
            }
        });
    }
    ...
    function initVirtualScrolling() {
        const productContainer = document.querySelector('.products-grid, .product-list, .products-container, [class*="product"]');
        if (!productContainer) return;

        const products = Array.from(productContainer.children);
        if (products.length < 20) return; // Only for large lists

        const itemHeight = 300; // Approximate height of each product
        ...
        const debouncedUpdate = debounce(updateVisibleItems, 16); // ~60fps
    ...
    function prefetchNextPage() {
        const nextPageLinks = document.querySelectorAll('a[href*="page="], .pagination a, .load-more');
    ...
    function initCacheManagement() {
        ...
        window.loadImage = function(img) {
            ...
            window.imageCache.set(src, true);
        };
    }
...
// Additional CSS optimizations (add to your CSS file)
/*
.product-card, .product-item, .product {
    will-change: transform, opacity;
}
