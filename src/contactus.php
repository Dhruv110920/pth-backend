...
<head>
    ...
    <title>Contact Us - Prabhat Tyre House</title>
  ...
  <div class="cart-content">
    ...
    <div class="container">
        <div class="contact-header">
            <h1>Contact Us</h1>
            <p>Get in touch with us for any inquiries, support, or feedback. We're here to help you!</p>
        </div>
        ...
        <div class="contact-content">
            <div class="contact-info">
                ...
                <div class="info-item">
                    ...
                    <p>Prabhat Tyre House<br>Shop no-8, Private Bus Stand opp Ramlila Gate<br>Delhi - Meerut Expy, Hapur, Uttar Pradesh 245101</p>
                </div>

                <div class="info-item">
                    <h3><i class="fas fa-phone"></i> Phone</h3>
                    <p><a href="tel:+919897540275" style="color: #333; text-decoration: none;">(+91) 9897540275</a></p>
                </div>
                ...
                <div class="info-item">
                    ...
                    <p><a href="mailto:prabhattyrehouse@gmail.com" style="color: #333; text-decoration: none;">prabhattyrehouse@gmail.com</a></p>
                </div>
            </div>

            <div class="contact-form">
                <h2><i class="fas fa-exclamation-triangle"></i> Raise a Complaint</h2>
                
                <div class="message success-message" id="successMessage">
                    <i class="fas fa-check-circle"></i> Your complaint has been submitted successfully! We'll get back to you soon.
                </div>
                ...
                <form id="contactForm" action="https://api.web3forms.com/submit" method="POST">
                    <input type="hidden" name="access_key" value="0b5b1145-b9aa-4f9f-9e01-239b91ca111c">
                    ...
                    <div class="form-group">
                        <label for="problem"><i class="fas fa-comment-alt"></i> Describe Your Problem *</label>
                        <textarea id="problem" name="message" placeholder="Please describe your issue in detail..." required></textarea>
                    </div>

                    <button type="submit" class="submit-btn">
                        <span class="loading-spinner" id="loadingSpinner"></span>
                        <i class="fas fa-paper-plane" id="submitIcon"></i>
                        <span id="buttonText">Raise Complaint</span>
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="map-section">
            ...
            <div class="map-container" onclick="openGoogleMaps()">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3498.7396894073567!2d77.7672679!3d28.729197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390c855d3206b0e5%3A0x7eace2730d59f5a3!2sPrabhat%20tyre%20house!5e0!3m2!1sen!2sin!4v1621234567890!5m2!1sen!2sin" 
                    allowfullscreen="" 
                    loading="lazy" 
                    referrerpolicy="no-referrer-when-downgrade">
                </iframe>
                <div class="map-overlay">
                    <div class="map-click-text">
...
function filterProducts(brand) {
    ...
    overlay.classList.toggle('active');
        ...
        document.getElementById('contactForm').addEventListener('submit', async function(e) {
            ...
            formData.append('from_name', 'Prabhat Tyre House Website');
            formData.append('subject', 'New Complaint from Prabhat Tyre House Website');
            ...
            setTimeout(() => {
                ...
                buttonText.textContent = 'Raise Complaint';
            ...
            try {
                ...
                console.log('Background submission completed');
            }
        });

        // Updated Open Google Maps function with mobile compatibility
function openGoogleMaps() {
    // Business details
    const businessName = 'Prabhat tyre house';
    const latitude = 28.729197;
    const longitude = 77.7698428;
    
    // Detect if user is on mobile
    const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    
    if (isMobile) {
        // For mobile devices, use simpler URL formats that work better with native apps
        const isAndroid = /Android/i.test(navigator.userAgent);
        const isIOS = /iPhone|iPad|iPod/i.test(navigator.userAgent);
        
        if (isAndroid) {
            // Android - try Google Maps app first, then fallback
            try {
                // Google Maps app URL for Android
                window.location.href = `geo:${latitude},${longitude}?q=${latitude},${longitude}(${encodeURIComponent(businessName)})`;
                
                // Fallback after a short delay if app doesn't open
                setTimeout(() => {
                    window.open(`https://maps.google.com/maps?q=${latitude},${longitude}&z=17&ll=${latitude},${longitude}`, '_blank');
                }, 1000);
            } catch (error) {
                // Direct fallback to Google Maps web
                window.open(`https://maps.google.com/maps?q=${latitude},${longitude}&z=17`, '_blank');
            }
        } else if (isIOS) {
            // iOS - try Maps app first, then Google Maps
            try {
                // iOS Maps app
                window.location.href = `maps:?q=${encodeURIComponent(businessName)}&ll=${latitude},${longitude}&z=17`;
            ...
            // Other mobile browsers - use simple Google Maps web URL
            window.open(`https://maps.google.com/maps?q=${latitude},${longitude}&z=17`, '_blank');
        }
    } else {
        // Desktop - use the full Google Maps URL (cleaned up)
        const desktopUrl = `https://www.google.com/maps/place/Prabhat+tyre+house/@${latitude},${longitude-0.0025749},17z/data=!3m1!4b1!4m6!3m5!1s0x390c855d3206b0e5:0x7eace2730d59f5a3!8m2!3d${latitude}!4d${longitude}!16s%2Fg%2F11hdqw6gj0`;
        window.open(desktopUrl, '_blank');
    }
}

// Alternative simpler function that works universally
function openGoogleMapsSimple() {
    const latitude = 28.729197;
    const longitude = 77.7698428;
    const businessName = 'Prabhat tyre house';
    
    // Universal URL that works on all devices
    const universalUrl = `https://www.google.com/maps/search/?api=1&query=${latitude},${longitude}&query_place_id=ChIJ5bAGMl2FbTkRo_VQDXMn6n4`;
    
    window.open(universalUrl, '_blank');
}

// Add click-to-call functionality and smooth scrolling
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('a[href^="tel:"]').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            console.log('Initiating call to:', this.href);
        });
    });
});

// Usage example:
// <button onclick="openGoogleMaps()">Open in Maps</button>
// or for the simpler version:
// <button onclick="openGoogleMapsSimple()">Open in Maps (Simple)</button>
