        ...
        <div class="product-content">
            ...
            <div class="product-details">
                ...
                <div class="product-price">
                    <span id="currentPrice">₹16,162</span>
                    <span class="original-price" id="originalPrice">₹16,818.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The EnduRace LD+ is a regional drive axle radial tyre, specifically developed for moderate-load long and short-haul trucks used in the e‑commerce, parcel, and logistics sectors. Built on Apollo’s CTO (Cord Tension Optimisation) casing with Load Bearing Technology, it delivers consistent mileage, robust puncture resistance, and excellent retreadability for cost-efficient operations. 
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Superior mileage via uniform contact pressure and optimized rubber distribution in the footprint.</li>
                        <li><i class="fas fa-check"></i> Cord Tension Optimisation (CTO) casing makes it retreadable and structurally resilient over life cycles.</li>
                        <li><i class="fas fa-check"></i> Load Bearing Technology (LBT) enhances carcass strength for heavy-load stability and puncture resistance.</li>
                        <li><i class="fas fa-check"></i> Robust belt construction counters puncture and tread damage, ensuring longer usable life. </li>
                        <li><i class="fas fa-check"></i>Fuel-efficient performance—rated in the higher-efficiency bands (like A–B), meaning ~3–4% lower fuel consumption per typical star rating differences.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo Tyres provides a 2-year standard manufacturer warranty on all its truck radial tyres, including the LD+. The warranty covers defects such as radial splits (without external impact), ply or bead separations, and material/manufacturing faults. Claims are evaluated on a pro‑rated basis and require inspection at an Apollo-authorized service center.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '27',
        inventoryId: 27, // Links to inventory system tire ID
        name: 'Endu Race LD+',
        brand: 'Apollo',
        price: 16172,
        originalPrice: 16818,
        category: 'high-performance',
        description: 'The EnduRace LD+ is a regional drive axle radial tyre, specifically developed for moderate-load long and short-haul trucks used in the e‑commerce, parcel, and logistics sectors. Built on Apollo’s CTO (Cord Tension Optimisation) casing with Load Bearing Technology, it delivers consistent mileage, robust puncture resistance, and excellent retreadability for cost-efficient operations.',
        features: [
            'Superior mileage via uniform contact pressure and optimized rubber distribution in the footprint.',
            'Cord Tension Optimisation (CTO) casing makes it retreadable and structurally resilient over life cycles.',
            'Load Bearing Technology (LBT) enhances carcass strength for heavy-load stability and puncture resistance.',
            'Robust belt construction counters puncture and tread damage, ensuring longer usable life.',
            'Fuel-efficient performance—rated in the higher-efficiency bands (like A–B), meaning ~3–4% lower fuel consumption per typical star rating differences.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
