        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="XLM.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Jet Xtra XLM</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹16,016</span>
                    <span class="original-price" id="originalPrice">₹16,816.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
             Jet Xtra XLM is a heavy-duty tube-type drive tyre designed for small and light commercial vehicles, catering to high-load, long-haul, and mixed-terrain operations. It features a strong casing, reinforced bead area, and advanced tread compound for improved mileage, load endurance, and retread potential.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Advanced tread compound for high mileage and slower wear.</li>
                        <li><i class="fas fa-check"></i>Reinforced casing and bead area designed for heavy-duty load handling. </li>
                        <li><i class="fas fa-check"></i>Designed for drive axle duty, ensuring strong traction and structural integrity.</li>
                        <li><i class="fas fa-check"></i>Tube-type bias construction, favoring retreadability and rugged terrain use.</li>
                        <li><i class="fas fa-check"></i>Built for demanding haulage use, blending load capacity with consistent performance. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The JK Tyre Jet Xtra XLM is covered under a 3-year warranty from the date of manufacture or purchase, whichever is earlier. It includes coverage for manufacturing defects such as casing or tread issues. Warranty claims are handled on a pro-rata basis, depending on the remaining tread depth. Physical damage, wear beyond the tread limit, or misuse are not covered.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '60',
        inventoryId: 60, // Links to inventory system tire ID
        name: 'Jet Xtra XLM',
        brand: 'JK',
        price: 16016,
        originalPrice: 16816,
        category: 'high-performance',
        description: 'Jet Xtra XLM is a heavy-duty tube-type drive tyre designed for small and light commercial vehicles, catering to high-load, long-haul, and mixed-terrain operations. It features a strong casing, reinforced bead area, and advanced tread compound for improved mileage, load endurance, and retread potential.',
        features: [
            'Advanced tread compound for high mileage and slower wear.',
            'Reinforced casing and bead area designed for heavy-duty load handling.',
            'Designed for drive axle duty, ensuring strong traction and structural integrity.',
            'Tube-type bias construction, favoring retreadability and rugged terrain use.',
            'Built for demanding haulage use, blending load capacity with consistent performance.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
