        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="RA.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RA(N)</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹19,156</span>
                    <span class="original-price" id="originalPrice">₹19,937.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo EnduRace RA(N) is a regional all-position tubed radial tyre engineered for high mileage across steer, drive, and trailer axle applications. It features a robust ribbed tread design and reinforced casing to deliver uniform wear, excellent load-bearing capability, and reduced rolling resistance—optimizing fuel efficiency and longevity in Indian regional transport conditions. 
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Robust rib tread architecture with optimized contact patch and circ­umferen­tial grooves for stable handling and even tread wear. </li>
                        <li><i class="fas fa-check"></i> Superior belt and carcass construction, offering high puncture resistance and structural durability under heavy loads.</li>
                        <li><i class="fas fa-check"></i> HOptimized tread profile—with straight grooves and tapered shoulders—to enhance traction while minimizing rolling resistance. </li>
                        <li><i class="fas fa-check"></i> Fuel efficiency performance: positioned in higher rating bands, supporting reduced fuel consumption by approximately 3–4% per rating level.</li>
                        <li><i class="fas fa-check"></i>Slow-wear compound formulation, designed for prolonged tread life and uniform rubber usage across its lifespan.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The EnduRace RA(N) carries a 2‑year manufacturer’s warranty in India. Warranty covers defects like radial splits (without visible external damage), ply or bead separation, and premature tread wear. Claims are subject to pro‑rata adjustment based on remaining tread and require inspection at Apollo-authorized service centers. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '44',
        inventoryId: 44, // Links to inventory system tire ID
        name: 'Endu Race RA(N)',
        brand: 'Apollo',
        price: 19156,
        originalPrice: 19936,
        category: 'high-performance',
        description: 'TThe Apollo EnduRace RA(N) is a regional all-position tubed radial tyre engineered for high mileage across steer, drive, and trailer axle applications. It features a robust ribbed tread design and reinforced casing to deliver uniform wear, excellent load-bearing capability, and reduced rolling resistance—optimizing fuel efficiency and longevity in Indian regional transport conditions.',
        features: [
            'Robust rib tread architecture with optimized contact patch and circ­umferen­tial grooves for stable handling and even tread wear.',
            'Superior belt and carcass construction, offering high puncture resistance and structural durability under heavy loads. ',
            'Optimized tread profile—with straight grooves and tapered shoulders—to enhance traction while minimizing rolling resistance.',
            'Fuel efficiency performance: positioned in higher rating bands, supporting reduced fuel consumption by approximately 3–4% per rating level. ',
            'Slow-wear compound formulation, designed for prolonged tread life and uniform rubber usage across its lifespan. ' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
...
function goToShop() { 
    ...
    setTimeout(() => {
        window.location.href = 'apollo1.php';
    }, 500);
}
