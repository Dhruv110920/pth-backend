        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="RA(T).png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RA(T)</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹19,297</span>
                    <span class="original-price" id="originalPrice">₹19,877.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The EnduRace RA (T) is a reinforced all‑wheel trailer/steer radial tyre optimized for moderate-load goods-carrier use. It features a continuous rib tread complemented by twisted and tapered grooves, using ACTO casing technology for excellent durability and retreadability. Designed to run cooler and more efficiently, it enables uniform wear and fuel savings under typical Indian road conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Continuous rib pattern with twisted & tapered grooves ensures uniform contact pressure and stable steering</li>
                        <li><i class="fas fa-check"></i> Lateral grooves with angular notches boost traction while keeping the tyre rolling efficiently.</li>
                        <li><i class="fas fa-check"></i> Cool-running tread compound and central rib dissipate heat efficiently, lowering rolling resistance.</li>
                        <li><i class="fas fa-check"></i> 2nd-generation ACTO casing provides a high-strength structure optimized for multiple retread cycles.</li>
                        <li><i class="fas fa-check"></i> Fuel efficiency ratings in the A‑B category reduce fuel costs by about 3–4%.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo Tyres offers a 2‑year manufacturer warranty on its truck tyres, including the EnduRace RA (T). Warranty coverage includes defects like radial splits (without visible external trauma), ply/bead separations, and manufacturing faults. Claims are pro‑rated based on inspection.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '23',
        inventoryId: 23, // Links to inventory system tire ID
        name: 'Endu Race RA(T)',
        brand: 'Apollo',
        price: 19297,
        originalPrice: 19877,
        category: 'high-performance',
        description: 'The EnduRace RA (T) is a reinforced all‑wheel trailer/steer radial tyre optimized for moderate-load goods-carrier use. It features a continuous rib tread complemented by twisted and tapered grooves, using ACTO casing technology for excellent durability and retreadability. Designed to run cooler and more efficiently, it enables uniform wear and fuel savings under typical Indian road conditions.',
        features: [
            'Continuous rib pattern with twisted & tapered grooves ensures uniform contact pressure and stable steering.',
            'Lateral grooves with angular notches boost traction while keeping the tyre rolling efficiently.',
            'Cool-running tread compound and central rib dissipate heat efficiently, lowering rolling resistance.',
            '2nd-generation ACTO casing provides a high-strength structure optimized for multiple retread cycles.',
            'Fuel efficiency ratings in the A‑B category reduce fuel costs by about 3–4%.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
