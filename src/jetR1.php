        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="Rmile.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Jet R Miles</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹13,723</span>
                    <span class="original-price" id="originalPrice">₹14,217.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
              The Jet R Miles is a heavy-duty tube-type drive tyre built for regional haulage—especially on city and off-road segments. Known for its high ply strength and bias construction, it delivers excellent load endurance, fuel efficiency, and long tyre life for small to medium-range trucking routes.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Heavy tube-type bias ply build (typically 16–18 PR) ensures strong casing performance and propensity for retreads.</li>
                        <li><i class="fas fa-check"></i>Fuel‑efficient compound optimized for city and haul routes, helping reduce rolling losses.</li>
                        <li><i class="fas fa-check"></i>Wide ribbed tread profile offering steering stability, predictable braking, and wear consistency.</li>
                        <li><i class="fas fa-check"></i> Cool running design that minimizes heat buildup—thus extending tread and casing life.</li>
                        <li><i class="fas fa-check"></i>Long tyre life with proven retreadability and durability under heavy usage.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Jet R Miles tyres from JK Tyre come with a 3-year warranty from the date of purchase or manufacture, whichever is earlier. The warranty covers manufacturing defects and is valid only for the original owner, subject to proper usage. Claims are settled on a pro-rata basis depending on remaining tread depth. Damages from misuse, wear beyond TWI, or road hazards are not covered.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '58',
        inventoryId: 58, // Links to inventory system tire ID
        name: 'Jet R Miles',
        brand: 'JK',
        price: 13723,
        originalPrice: 15217,
        category: 'high-performance',
        description: 'The Jet R Miles is a heavy-duty tube-type drive tyre built for regional haulage—especially on city and off-road segments. Known for its high ply strength and bias construction, it delivers excellent load endurance, fuel efficiency, and long tyre life for small to medium-range trucking routes.',
        features: [
            'Heavy tube-type bias ply build (typically 16–18 PR) ensures strong casing performance and propensity for retreads.',
            'Fuel‑efficient compound optimized for city and haul routes, helping reduce rolling losses.',
            'Wide ribbed tread profile offering steering stability, predictable braking, and wear consistency.',
            'Cool running design that minimizes heat buildup—thus extending tread and casing life.',
            'Long tyre life with proven retreadability and durability under heavy usage.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
