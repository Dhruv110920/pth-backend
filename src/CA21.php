        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="ca2.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Comfort CA2</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹19,440</span>
                    <span class="original-price" id="originalPrice">₹20,229.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo EnduComfort CA2 is a premium coach‑segment radial tyre designed for medium and long‑distance transport. It delivers exceptional ride comfort and low noise, with thanks to its ribbed tread layout and high tread volume. Built with a reinforced ACTO casing, it offers even wear, fuel-efficient performance, and consistent all-weather grip.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Reinforced tread compound with optimally spaced ribs and increased tread volume helps reduce wear and extends tyre life.</li>
                        <li><i class="fas fa-check"></i> Superior all‑weather traction achieved through lateral sipes, deep cuts, and ventilated grooves for reliable grip in wet or snowy conditions.</li>
                        <li><i class="fas fa-check"></i> Low noise and smooth handling, thanks to its ribbed pattern and balanced rubber mass distribution for comfort on long hauls.</li>
                        <li><i class="fas fa-check"></i> ACTO casing design with special bead reinforcement contributes to structural flexibility and makes it easier to operate during continuous haul operations.</li>
                        <li><i class="fas fa-check"></i>High wet‑grip and braking performance, supported by a tread pattern optimized for traction and safe stopping distances in diverse conditions.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2-year manufacturer’s warranty on the EnduComfort CA2. It covers defects such as radial splits (without external trauma), ply or bead separation, and premature tread wear. Warranty claims are evaluated on a pro‑rata basis, subject to inspection at authorized Apollo service centres. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '43',
        inventoryId: 43, // Links to inventory system tire ID
        name: 'Endu Comfort CA2',
        brand: 'Apollo',
        price: 19440,
        originalPrice: 20229,
        category: 'high-performance',
        description: 'The Apollo EnduComfort CA2 is a premium coach‑segment radial tyre designed for medium and long‑distance transport. It delivers exceptional ride comfort and low noise, with thanks to its ribbed tread layout and high tread volume. Built with a reinforced ACTO casing, it offers even wear, fuel-efficient performance, and consistent all-weather grip.',
        features: [
            'Reinforced tread compound with optimally spaced ribs and increased tread volume helps reduce wear and extends tyre life.',
            'Superior all‑weather traction achieved through lateral sipes, deep cuts, and ventilated grooves for reliable grip in wet or snowy conditions.',
            'Low noise and smooth handling, thanks to its ribbed pattern and balanced rubber mass distribution for comfort on long hauls.',
            'ACTO casing design with special bead reinforcement contributes to structural flexibility and makes it easier to operate during continuous haul operations. ',
            'High wet‑grip and braking performance, supported by a tread pattern optimized for traction and safe stopping distances in diverse conditions.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
