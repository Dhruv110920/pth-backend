...
<div class="product-card" data-id="58" data-redirect="jetR1.php" data-name="Jet R Miles">
    ...
    <div class="product-price">₹13,723</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: Jet R Xtra Miles -->
                    <div class="product-card" data-id="59" data-redirect="RX1.php" data-name="Jet R Xtra Miles">
                        <div class="product-image">
                    ...
                    <div class="product-card" data-id="60" data-redirect="X1.php" data-name="Jet Xtra XLM">
                        <div class="product-image">
                    ...
                    <div class="product-card" data-id="61" data-redirect="LUG+1.php" data-name="Vikrant Trak LUG+">
                        <div class="product-image">
                    ...
                    <!-- Product 7: JDC XD -->
                    <div class="product-card" data-id="64" data-redirect="jdc1.php" data-name="JDC XD">
                        <div class="product-image">
