...
<div class="product-card" data-id="1" data-redirect="m751hl.php" data-name="M751 HL">
    ...
    <div class="product-price">₹21,641</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: Bridgestone Turanza T005 -->
                    <div class="product-card"  data-redirect="R271.php" data-name="R271">
                        <div class="product-image">
...
<!-- Product 4: Endu Race RA -->
                    ...
                    <!-- Product 5: JUH 5 -->
                    <div class="product-card" data-id="62" data-redirect="JUH5.php" data-name="JUH 5">
                        <div class="product-image">
                            <img src="juh5.png" alt="JUH 5" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">JK</div>
                        <div class="product-name">JUH 5</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹18,377</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 6: JDE++ -->
                    <div class="product-card" data-id="63" data-redirect="jde++.php" data-name="JDE++">
                        <div class="product-image">
                            <img src="jde++.jpg" alt="JDE++" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">JK</div>
                        <div class="product-name">JDE++</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19,504</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 3: X Multi Z 2 -->
                    <div class="product-card" data-id="67" data-redirect="Z2.php" data-name="X Multi Z 2">
                        <div class="product-image">
                            <img src="Z2.png.webp" alt="X Multi Z 2" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Michelin</div>
                        <div class="product-name">X Multi Z 2</div>
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹24,414</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    window.ecommerceAPI.displayProducts('products-container');
});
</script>
