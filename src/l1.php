        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="LD.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race LD</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹14,453</span>
                    <span class="original-price" id="originalPrice">₹15,048.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Apollo EnduRace LD S (also labeled simply as EnduRace LD in some markets) is a drive-axle radial tyre optimised for light commercial vehicles and regional haulage across India. It features robust tread blocks for heavy-load traction, reduced heat build-up, and cut‑chip resistance, ensuring smooth, long-lasting wear. The casing uses tension-optimised cords for high durability and support for multiple retreads. Selected 16″ SKUs even earned a 5‑star energy‑efficiency rating from the Bureau of Energy Efficiency for fuel savings and performance.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Strong Tread Blocks – Provide excellent traction and durability under heavy load conditions.</li>
                        <li><i class="fas fa-check"></i> Cut and Chip Resistance – Designed to handle rough roads with minimal damage and longer life.</li>
                        <li><i class="fas fa-check"></i> Heat-Resistant Compound – Reduces heat build-up, improving performance during long hauls.</li>
                        <li><i class="fas fa-check"></i> Retreadable Casing – Built with strong tension-optimised cords for extended casing life and multiple retreads.</li>
                        <li><i class="fas fa-check"></i> 5-Star Energy Rating (select sizes) – Recognized for superior fuel efficiency and rolling resistance by India’s BEE.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>the Apollo EnduRace LD S tyre comes with a standard limited warranty that covers manufacturing defects in materials and workmanship for up to 5 years from the date of production or purchase, or until the tyre reaches the tread wear indicator—whichever comes first. Tyres with minimal wear may be replaced free of charge, while others may receive a pro-rata credit based on remaining tread. The warranty excludes damages caused by overloading, improper inflation, road hazards, or mechanical issues. Claims must be submitted through an authorized Apollo dealer with proper documentation.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '29',
        inventoryId: 29, // Links to inventory system tire ID
        name: 'Endu Race LD',
        brand: 'Apollo',
        price: 14453,
        originalPrice: 15048,
        category: 'high-performance',
        description: 'The Apollo EnduRace LD S (also labeled simply as EnduRace LD in some markets) is a drive-axle radial tyre optimised for light commercial vehicles and regional haulage across India. It features robust tread blocks for heavy-load traction, reduced heat build-up, and cut‑chip resistance, ensuring smooth, long-lasting wear. The casing uses tension-optimised cords for high durability and support for multiple retreads. Selected 16″ SKUs even earned a 5‑star energy‑efficiency rating from the Bureau of Energy Efficiency for fuel savings and performance.',
        features: [
            'Strong Tread Blocks – Provide excellent traction and durability under heavy load conditions.',
            'Cut and Chip Resistance – Designed to handle rough roads with minimal damage and longer life.',
            'Heat-Resistant Compound – Reduces heat build-up, improving performance during long hauls.',
            'Retreadable Casing – Built with strong tension-optimised cords for extended casing life and multiple retreads.',
            '5-Star Energy Rating (select sizes) – Recognized for superior fuel efficiency and rolling resistance by India’s BEE.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
