        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="tr21.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">BOSS TR 21</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹14,869</span>
                    <span class="original-price" id="originalPrice">₹18,531.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The Ascenso Boss TR 21 is a trailer tyre designed for agricultural transport on both on-road and off-road surfaces.  
                   It features a high contact patch and strong lug pattern for better stability and uniform wear. Its robust construction supports heavy loads,
                  while the special tread compound enhances durability and resistance to cuts and punctures.

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High Contact Patch – Ensures uniform tread wear and stable performance on varied surfaces. </li>
                        <li><i class="fas fa-check"></i> Strong Lug Design – Provides excellent grip and traction during trailer movement. </li>
                        <li><i class="fas fa-check"></i> Heavy Load Capacity – Built to carry substantial trailer loads efficiently. </li>
                        <li><i class="fas fa-check"></i> Durable Tread Compound – Offers longer tyre life and better resistance to cuts and abrasions.</li>
                        <li><i class="fas fa-check"></i> Versatile Use – Suitable for both on-road and off-road agricultural transport conditions.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p> The Ascenso Boss TR 21 tyre is backed by the manufacturer’s warranty, which typically covers defects in material or workmanship. For bias‑ply tyres like the TR 21, Ascenso provides a 5‑year limited warranty from the date of manufacture. Coverage applies only under normal use—issues arising from misuse, overloading, improper mounting, or damage from external hazards are excluded. Claims must be initiated through an authorized Ascenso dealer with proof of purchase, and final eligibility is determined by inspection.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '16',
        inventoryId: 16, // Links to inventory system tire ID
        name: 'BOSS TR 21',
        brand: 'Ascenso',
        price: 14869,
        originalPrice: 18531,
        category: 'high-performance',
        description: 'The Ascenso Boss TR 21 is a trailer tyre designed for agricultural transport on both on-road and off-road surfaces. It features a high contact patch and strong lug pattern for better stability and uniform wear. Its robust construction supports heavy loads, while the special tread compound enhances durability and resistance to cuts and punctures.',
        features: [
            'High Contact Patch – Ensures uniform tread wear and stable performance on varied surfaces.',
            'Strong Lug Design – Provides excellent grip and traction during trailer movement.',
            'Heavy Load Capacity – Built to carry substantial trailer loads efficiently.',
            'Durable Tread Compound – Offers longer tyre life and better resistance to cuts and abrasions.',
            'Versatile Use – Suitable for both on-road and off-road agricultural transport conditions.'
        ], 
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
