        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="xt100.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">XT 100 HD X-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹15,131</span>
                    <span class="original-price" id="originalPrice">₹15,791.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
              The XT‑100 HD X‑D is a robust cross-ply lug-pattern drive tyre engineered for regional haulage and mixed-route truck/bus applications. It features a reinforced casing and high tread volume to offer superior load endurance, mileage, and cooler running—designed to excel under tough conditions. 
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Modular Matrix Tread (MMT) creates deep cross-lugs and tie-bar structure for enhanced traction and even wear.</li>
                        <li><i class="fas fa-check"></i>High-strength casing built with advanced nylon fabric to boost load durability and structural strength.</li>
                        <li><i class="fas fa-check"></i>HEART technology (Heat-Ageing Resistant Compound + Tyre Cavity design) enables cooler running and better casing retention for retreads. </li>
                        <li><i class="fas fa-check"></i> Fuel-efficient tread compound and deep rubber mass support extended mileage and low rolling resistance. </li>
                        <li><i class="fas fa-check"></i>High retreadability, thanks to its durable casing and optimized footprint designed for multiple lifecycles.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2-year manufacturer’s warranty for the XT‑100 HD X‑D. It covers defects like radial splits (not caused by visible external damage), ply or bead separation, and premature tread wear. Warranty claims are handled on a pro‑rata basis after inspection at authorized service centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '54',
        inventoryId: 54, // Links to inventory system tire ID
        name: 'XT 100 HD X-D',
        brand: 'Apollo',
        price: 15131,
        originalPrice: 15791,
        category: 'high-performance',
        description: 'The XT‑100 HD X‑D is a robust cross-ply lug-pattern drive tyre engineered for regional haulage and mixed-route truck/bus applications. It features a reinforced casing and high tread volume to offer superior load endurance, mileage, and cooler running—designed to excel under tough conditions.',
        features: [
            'Modular Matrix Tread (MMT) creates deep cross-lugs and tie-bar structure for enhanced traction and even wear.',
            'High-strength casing built with advanced nylon fabric to boost load durability and structural strength.',
            'HEART technology (Heat-Ageing Resistant Compound + Tyre Cavity design) enables cooler running and better casing retention for retreads.',
            'Fuel-efficient tread compound and deep rubber mass support extended mileage and low rolling resistance. ',
            'High retreadability, thanks to its durable casing and optimized footprint designed for multiple lifecycles.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
