        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="MD+.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Trax MD+</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,195</span>
                    <span class="original-price" id="originalPrice">₹20,962.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The EnduTrax MD+ is a rugged mixed-service drive position tyre crafted for tipper trucks and trailers operating across both on‑road and off‑road conditions. It features an extra-wide tread, a next-gen compound, and strengthened shoulders—designed to resist cut and chip damage, carry heavy loads, and deliver unmatched durability and traction in demanding infrastructure operations. 
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Extra-wide tread enhances footprint stability and improves mileage under heavy loads.</li>
                        <li><i class="fas fa-check"></i> Next-gen compound designed for superior grip while resisting chipping and cuts even in aggressive terrain.</li>
                        <li><i class="fas fa-check"></i> Reinforced shoulder blocks boost load-carrying capability and ensure structural integrity under torque.</li>
                        <li><i class="fas fa-check"></i> Layered elastomer matrix technology + ACTO casing provides extra cushioning and stone ejectors—resulting in high impact resistance and multiple retread lifespan. </li>
                        <li><i class="fas fa-check"></i>Distributed block footprint with rounded tie‑bars ensures consistent traction and stability in slush, mud, or gravel. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2‑year manufacturer’s warranty on all commercial vehicle radials, including the EnduTrax MD+. It covers manufacturing defects such as radial splits (without visible impact), ply or bead separation, and material faults. Warranty claims follow pro‑rating based on remaining tread depth and require inspection by an Apollo-authorized dealer.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '26',
        inventoryId: 26, // Links to inventory system tire ID
        name: 'Endu Trax MD+',
        brand: 'Apollo',
        price: 20195,
        originalPrice: 20962,
        category: 'high-performance',
        description: 'The EnduTrax MD+ is a rugged mixed-service drive position tyre crafted for tipper trucks and trailers operating across both on‑road and off‑road conditions. It features an extra-wide tread, a next-gen compound, and strengthened shoulders—designed to resist cut and chip damage, carry heavy loads, and deliver unmatched durability and traction in demanding infrastructure operations.',
        features: [
            'Extra-wide tread enhances footprint stability and improves mileage under heavy loads.',
            'Next-gen compound designed for superior grip while resisting chipping and cuts even in aggressive terrain.',
            'Reinforced shoulder blocks boost load-carrying capability and ensure structural integrity under torque. ',
            'Layered elastomer matrix technology + ACTO casing provides extra cushioning and stone ejectors—resulting in high impact resistance and multiple retread lifespan. ',
            'Distributed block footprint with rounded tie‑bars ensures consistent traction and stability in slush, mud, or gravel.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
