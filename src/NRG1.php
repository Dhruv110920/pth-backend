        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="NRG.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RA NRG</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹18,672</span>
                    <span class="original-price" id="originalPrice">₹19,393.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Apollo EnduRace RA nRG is a fuel-efficient steer/all-position radial tyre tailored for regional and light‑commercial vehicle use. It offers excellent fuel savings—with rolling-resistance gains of around 3–4% per efficiency grade—and delivers durable performance via a robust casing and low heat build-up. The tread design promotes uniform wear and long life under diverse operating conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Low rolling resistance thanks to cooler tread compounds and optimized tread design, enhancing fuel efficiency by ~5–8% in real-world conditions.</li>
                        <li><i class="fas fa-check"></i> Special groove pattern with lateral grooves featuring angular notches for traction, stability, and reduced heat generation.</li>
                        <li><i class="fas fa-check"></i> ACTO multi-life casing design, engineered for multiple retreading cycles to extend tyre lifespan.</li>
                        <li><i class="fas fa-check"></i> Tension-optimized carcass and strong belt/bead package for enhanced durability and load handling.</li>
                        <li><i class="fas fa-check"></i> Even contact patch distribution, promoting uniform tread wear and maximizing mileage over the tyre’s operational life.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2-year manufacturer’s warranty on all its commercial vehicle tyres, including the EnduRace RA nRG. This warranty covers defects like radial splits (without external damage), ply or bead issues, and manufacturing flaws. Claims are assessed on a pro‑rata basis and subject to inspection under terms outlined by Apollo support.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '21',
        inventoryId: 21, // Links to inventory system tire ID
        name: 'Endu Race RA NRG',
        brand: 'Apollo',
        price: 18672,
        originalPrice: 19393,
        category: 'high-performance',
        description: 'The Apollo EnduRace RA nRG is a fuel-efficient steer/all-position radial tyre tailored for regional and light‑commercial vehicle use. It offers excellent fuel savings—with rolling-resistance gains of around 3–4% per efficiency grade—and delivers durable performance via a robust casing and low heat build-up. The tread design promotes uniform wear and long life under diverse operating conditions.',
        features: [
            'Low rolling resistance thanks to cooler tread compounds and optimized tread design, enhancing fuel efficiency by ~5–8% in real-world conditions .',
            'Special groove pattern with lateral grooves featuring angular notches for traction, stability, and reduced heat generation.',
            'ACTO multi-life casing design, engineered for multiple retreading cycles to extend tyre lifespan.',
            'Tension-optimized carcass and strong belt/bead package for enhanced durability and load handling.',
            'Even contact patch distribution, promoting uniform tread wear and maximizing mileage over the tyre’s operational life .'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
