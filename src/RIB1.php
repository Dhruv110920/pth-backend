        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="rib.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">VIHAAN RIB (SV)-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹5,379</span>
                    <span class="original-price" id="originalPrice">₹5,746.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo Vihaan Rib (SV)‑D is a tube-type, rib-pattern drive tyre built especially for small and medium commercial vehicles (SCVs). It offers a rugged design optimized for heavy payloads and consistent wear over long hauls—ideal for intercity and urban logistics operations.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Ribbed tread design for stable steering, even wear, and smoother road contact.</li>
                        <li><i class="fas fa-check"></i> Tube-type construction with high ply strength, delivering load durability under heavy SCV usage.</li>
                        <li><i class="fas fa-check"></i> Heat-resistant compound and reinforced ply, enabling consistent performance under high torque and prolonged trips.</li>
                        <li><i class="fas fa-check"></i> Optimized rubber distribution, maximizing mileage and reducing uneven abrasion on Indian roads.</li>
                        <li><i class="fas fa-check"></i>Built for heavy-duty SCV fleets, designed for high load endurance and uptime reliability. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo Tyres provides a standard 2‑year manufacturer warranty on its commercial vehicle tyres, including the Vihaan series. The warranty covers radial splits (excluding visible trauma), ply/bead separations, and manufacturing defects. Claims are evaluated on a pro‑rata basis, subject to inspection at certified Apollo centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '38',
        inventoryId: 38, // Links to inventory system tire ID
        name: 'VIHAAN RIB (SV)-D',
        brand: 'Apollo',
        price: 5379,
        originalPrice: 5746,
        category: 'high-performance',
        description: 'The Apollo Vihaan Rib (SV)‑D is a tube-type, rib-pattern drive tyre built especially for small and medium commercial vehicles (SCVs). It offers a rugged design optimized for heavy payloads and consistent wear over long hauls—ideal for intercity and urban logistics operations.',
        features: [
            'Ribbed tread design for stable steering, even wear, and smoother road contact.',
            'Tube-type construction with high ply strength, delivering load durability under heavy SCV usage.',
            'Heat-resistant compound and reinforced ply, enabling consistent performance under high torque and prolonged trips.',
            'Optimized rubber distribution, maximizing mileage and reducing uneven abrasion on Indian roads.',
            'Built for heavy-duty SCV fleets, designed for high load endurance and uptime reliability.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
