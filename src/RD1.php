        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="rd.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RD</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,042</span>
                    <span class="original-price" id="originalPrice">₹20,849.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo EnduRace RD is a long‑life regional drive radial tyre built for trucks and buses in distribution and regional haulage. It features an optimized central block tread and a stress‑limiting carcass design for high mileage, load endurance, and smooth fleet operation. This drive tyre balances traction, fuel-efficiency, and excellent retread potential.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Reinforced slow‑wear compound delivers significantly higher mileage compared to standard regional drive tyres.</li>
                        <li><i class="fas fa-check"></i> Stress‑limiting carcass design, engineered for multiple retreads without casing fatigue, enhancing tyre lifecycle. </li>
                        <li><i class="fas fa-check"></i> Optimized central block and squared footprint promote even pressure distribution and stable traction in varied conditions. </li>
                        <li><i class="fas fa-check"></i> Excellent traction in wet and dry weather thanks to footprint equalization and balanced rubber volume.</li>
                        <li><i class="fas fa-check"></i>Fuel efficiency & noise performance, rated in high bands (e.g. B–C), reducing rolling resistance and external noise. The drive tyre typically offers 3–4% fuel savings per rating band improvement.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2‑year standard manufacturer’s warranty on EnduRace RD tyres. Sparked claims cover radial splits (not caused by visible external trauma), ply or bead separation, and premature tread wear. All claims follow a pro‑rated assessment after inspection at authorized Apollo centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '45',
        inventoryId: 45, // Links to inventory system tire ID
        name: 'Endu Race RD',
        brand: 'Apollo',
        price: 20042,
        originalPrice: 20849,
        category: 'high-performance',
        description: 'The Apollo EnduRace RD is a long‑life regional drive radial tyre built for trucks and buses in distribution and regional haulage. It features an optimized central block tread and a stress‑limiting carcass design for high mileage, load endurance, and smooth fleet operation. This drive tyre balances traction, fuel-efficiency, and excellent retread potential. ',
        features: [
            'Reinforced slow‑wear compound delivers significantly higher mileage compared to standard regional drive tyres.',
            'Stress‑limiting carcass design, engineered for multiple retreads without casing fatigue, enhancing tyre lifecycle.',
            'Optimized central block and squared footprint promote even pressure distribution and stable traction in varied conditions.',
            'Excellent traction in wet and dry weather thanks to footprint equalization and balanced rubber volume. ',
            'Fuel efficiency & noise performance, rated in high bands (e.g. B–C), reducing rolling resistance and external noise. The drive tyre typically offers 3–4% fuel savings per rating band improvement.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
