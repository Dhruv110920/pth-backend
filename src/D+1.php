    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">X Multi D+</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹24,844</span>
                    <span class="original-price" id="originalPrice">₹25,978.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The Michelin X Multi D+ is a next-generation regional drive radial tyre engineered for long-haul and line-haul trucking. It delivers excellent traction, fuel-saving efficiency, and high mileage—thanks to its cool-running compound and robust casing technologies, optimized for Indian conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Co‑extruded scrub-resistant rubber delivers more mileage in demanding haul applications.</li>
                        <li><i class="fas fa-check"></i>Low rolling resistance design lowers fuel consumption by over 5% versus predecessor models..</li>
                        <li><i class="fas fa-check"></i>Matrix siping—full depth interlocking sipes offer consistent traction and even tread wear.</li>
                        <li><i class="fas fa-check"></i>Full-width protector ply shields the casing from punctures and impact damage.</li>
                        <li><i class="fas fa-check"></i>Cooler running compound enhances casing life and supports multiple retreads.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Michelin commercial tyres—including the X Multi D+—typically come with a 2‑year manufacturer warranty. This covers material or workmanship defects such as casing separation or trend delamination. Warranty claims are handled on a pro‑rata basis based on remaining tread life; external damage or misuse are not covered.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '68',
        inventoryId: 68, // Links to inventory system tire ID
        name: 'X Multi D+',
        brand: 'Michelin',
        price: 24844,
        originalPrice: 25978,
        category: 'high-performance',
        description: 'The Michelin X Multi D+ is a next-generation regional drive radial tyre engineered for long-haul and line-haul trucking. It delivers excellent traction, fuel-saving efficiency, and high mileage—thanks to its cool-running compound and robust casing technologies, optimized for Indian conditions.',
        features: [
            'The Michelin X Multi D+ is a next-generation regional drive radial tyre engineered for long-haul and line-haul trucking. It delivers excellent traction, fuel-saving efficiency, and high mileage—thanks to its cool-running compound and robust casing technologies, optimized for Indian conditions.',
            'Low rolling resistance design lowers fuel consumption by over 5% versus predecessor models.',
            'Matrix siping—full depth interlocking sipes offer consistent traction and even tread wear.',
            'Full-width protector ply shields the casing from punctures and impact damage.',
            'Cooler running compound enhances casing life and supports multiple retreads.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
