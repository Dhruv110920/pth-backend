    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RA-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹10,498</span>
                    <span class="original-price" id="originalPrice">₹11,018.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                 The Apollo EnduRace RA‑D is a heavy-duty radial drive tyre tailored for high-load haul and long-distance transport. Built with reinforced casing and tube-type construction, it delivers outstanding load-bearing capability, stable handling, and sustained mileage under tough regional and highway conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Tube‑type design with high ply rating for superior load endurance and resistance to structural fatigue.</li>
                        <li><i class="fas fa-check"></i> Reinforced carcass and belt construction to enhance puncture protection and improve stability under heavy loads.</li>
                        <li><i class="fas fa-check"></i> Engineered for long mileage, utilizing optimized tread profiles and abrasion-resistant compounds.</li>
                        <li><i class="fas fa-check"></i> Straight-line handling stability, reducing rolling resistance and enhancing control during extended hauls.</li>
                        <li><i class="fas fa-check"></i>Noise reduction technology, contributing to quieter operation on the road and better driver comfort.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2‑year manufacturer’s warranty on this tyre. It covers manufacturing defects such as radial splits (with no external damage), ply or bead separation, and premature tread wear. Claims are evaluated on a pro‑rated basis after inspection at an authorized service center.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '35',
        inventoryId: 35, // Links to inventory system tire ID
        name: 'Endu Race RA-D',
        brand: 'Apollo',
        price: 10498,
        originalPrice: 11018,
        category: 'high-performance',
        description: 'The Apollo EnduRace RA‑D is a heavy-duty radial drive tyre tailored for high-load haul and long-distance transport. Built with reinforced casing and tube-type construction, it delivers outstanding load-bearing capability, stable handling, and sustained mileage under tough regional and highway conditions.',
        features: [
            'Tube‑type design with high ply rating for superior load endurance and resistance to structural fatigue.',
            'Reinforced carcass and belt construction to enhance puncture protection and improve stability under heavy loads.',
            'Engineered for long mileage, utilizing optimized tread profiles and abrasion-resistant compounds.',
            'Straight-line handling stability, reducing rolling resistance and enhancing control during extended hauls.',
            'Noise reduction technology, contributing to quieter operation on the road and better driver comfort.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
