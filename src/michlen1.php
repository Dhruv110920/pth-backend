...
<div class="product-card" data-id="65" data-redirect="Z+1.php" data-name="X Multi Energy Z+">
    ...
    <div class="product-price">₹22,578</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: X Multi Energy D -->
                    <div class="product-card" data-id="66" data-redirect="xD1.php" data-name="X Multi Energy D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹24,062</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    ...
                    <!-- Product 4:X Multi D+ -->
                    <div class="product-card" data-id="68" data-redirect="D+1.php" data-name="X Multi D+">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹24,844</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
