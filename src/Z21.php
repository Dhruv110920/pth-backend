        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="Z2.png.webp" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">X Multi Energy Z2</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹23,711</span>
                    <span class="original-price" id="originalPrice">₹24,902.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The Michelin X Multi Energy Z2 is an all-position radial tyre, designed to offer up to 30% more mileage and excellent wear consistency across steer, drive, and trailer positions. It features advanced innovations like Regenion™ technology for self-regenerating grooves and Duracoil® casing, making it ideal for long-distance and high-edged haul operations in India.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Regenion™ self-regenerating grip: New micro-grooves form as the tread wears—ensuring grip is maintained throughout tyre life.</li>
                        <li><i class="fas fa-check"></i>Duracoil® reinforced casing: Continuous steel coil layers improve bead strength and long-term stability—even during retreads.</li>
                        <li><i class="fas fa-check"></i>Expanded load index & footprint: Supports higher axle load capacity (+5–12%) with wider contact patch for even wear and extended mileage.</li>
                        <li><i class="fas fa-check"></i>Low rolling resistance design: Contributes to lower fuel consumption—up to 8% better efficiency than preceding generations.</li>
                        <li><i class="fas fa-check"></i>Outstanding retread life: Built for high retreadability—offering up to 5% improvements over predecessors in casing life.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Michelin commercial tyres like the X Multi Energy Z2 typically carry a 2‑year manufacturer warranty in India, covering defects in materials or workmanship such as casing separation or tread delamination. Warranty claims are handled on a pro‑rata basis—based on remaining usable tread life—and exclude physical damage, misuse, or wear beyond legal thresholds.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '67',
        inventoryId: 67, // Links to inventory system tire ID
        name: 'X Multi Energy Z2',
        brand: 'Michelin',
        price: 23711,
        originalPrice: 24902,
        category: 'high-performance',
        description: 'The Michelin X Multi Energy Z2 is an all-position radial tyre, designed to offer up to 30% more mileage and excellent wear consistency across steer, drive, and trailer positions. It features advanced innovations like Regenion™ technology for self-regenerating grooves and Duracoil® casing, making it ideal for long-distance and high-edged haul operations in India.',
        features: [
            'Regenion™ self-regenerating grip: New micro-grooves form as the tread wears—ensuring grip is maintained throughout tyre life.',
            'Duracoil® reinforced casing: Continuous steel coil layers improve bead strength and long-term stability—even during retreads.',
            'Expanded load index & footprint: Supports higher axle load capacity (+5–12%) with wider contact patch for even wear and extended mileage.',
            'Low rolling resistance design: Contributes to lower fuel consumption—up to 8% better efficiency than preceding generations.',
            'Outstanding retread life: Built for high retreadability—offering up to 5% improvements over predecessors in casing life.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
