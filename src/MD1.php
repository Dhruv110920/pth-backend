        ...
        <div class="product-content">
            ...
            <div class="product-details">
                ...
                <div class="product-price">
                    <span id="currentPrice">₹21,719</span>
                    <span class="original-price" id="originalPrice">₹22,531.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Apollo EnduTrax MD is a heavy-duty drive axle tyre engineered for mixed-service use—especially suited to tipper trucks traversing both on-road and off-road terrains. It’s built for high uptime with rugged traction, cut/chip resistance, and long casing life thanks to reinforced construction and cushioning technology. 
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Excellent traction via rugged block pattern and cap-shaped tie bars that self-clean, improving grip in muddy or slushy terrain.</li>
                        <li><i class="fas fa-check"></i> Cut & chip resistant compound engineered to endure abrasive surfaces, minimizing damage in harsh work environments.</li>
                        <li><i class="fas fa-check"></i> Stone ejectors and extra cushioning rubber (≈14%), enhancing impact resistance and protecting the casing from stone drilling.</li>
                        <li><i class="fas fa-check"></i> Reinforced bead design, offering improved stability under load and reducing sidewall deformation to extend tyre life.</li>
                        <li><i class="fas fa-check"></i> Multiple-retread casing, built using ACTO and elastomer layering technologies suited for several retreading cycles.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2-year standard manufacturer’s warranty on its commercial vehicle tyres, including the EnduTrax MD. Coverage includes radial splits (without visible impact), ply or bead separations, and material/manufacturing defects. Claims are assessed on a pro-rated basis, contingent upon inspection at an authorised Apollo centre. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '31',
        inventoryId: 31, // Links to inventory system tire ID
        name: 'Endu Trax MD',
        brand: 'Apollo',
        price: 21719,
        originalPrice: 22531,
        category: 'high-performance',
        description: 'The Apollo EnduTrax MD is a heavy-duty drive axle tyre engineered for mixed-service use—especially suited to tipper trucks traversing both on-road and off-road terrains. It’s built for high uptime with rugged traction, cut/chip resistance, and long casing life thanks to reinforced construction and cushioning technology.',
        features: [
            'Excellent traction via rugged block pattern and cap-shaped tie bars that self-clean, improving grip in muddy or slushy terrain.',
            'Cut & chip resistant compound engineered to endure abrasive surfaces, minimizing damage in harsh work environments. ',
            'Stone ejectors and extra cushioning rubber (≈14%), enhancing impact resistance and protecting the casing from stone drilling.',
            'Reinforced bead design, offering improved stability under load and reducing sidewall deformation to extend tyre life.',
            'Multiple-retread casing, built using ACTO and elastomer layering technologies suited for several retreading cycles. '
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
