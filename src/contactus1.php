...
function filterProducts(brand) {
    ...
    overlay.classList.toggle('active');
        ...
        // Updated Open Google Maps function with correct location
        function openGoogleMaps() {
            // Using the exact Google Maps URL you provided
            const googleMapsUrl = 'https://www.google.co.in/maps/place/Prabhat+tyre+house/@28.729197,77.7672679,17z/data=!3m1!4b1!4m6!3m5!1s0x390c855d3206b0e5:0x7eace2730d59f5a3!8m2!3d28.729197!4d77.7698428!16s%2Fg%2F11hdqw6gj0?entry=ttu&g_ep=EgoyMDI1MDcwOS4wIKXMDSoASAFQAw%3D%3D';
            
            // Detect if user is on mobile
            const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
            
            if (isMobile) {
                // On mobile, try to open native maps app first, fallback to browser
                try {
                    // Try to open with place ID for better accuracy
                    window.open(`https://maps.google.com/?cid=9133680076068652451`, '_blank');
                } catch (error) {
                    // Fallback to the provided URL
                    window.open(googleMapsUrl, '_blank');
                }
            } else {
                // On desktop, open the provided Google Maps URL
                window.open(googleMapsUrl, '_blank');
            }
        }
