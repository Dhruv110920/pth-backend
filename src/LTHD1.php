        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="LTHD.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Maxx LT HD(LV)-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹6,787</span>
                    <span class="original-price" id="originalPrice">₹7,197.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                The EnduMaxx LT HD (LV)‑D is a rugged, heavy-duty tubed radial tyre crafted for light trucks and pickups under extreme load and mixed terrain. Its robust tread design delivers exceptional off-road traction and durability, making it ideal for commercial and rural logistics operations. Purpose-built to handle high payloads while maintaining stability, fuel efficiency, and long life.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Heavy-load bead construction offers best‑in‑class structural strength for demanding operations.</li>
                        <li><i class="fas fa-check"></i> All‑terrain tread pattern delivers high puncture resistance, grip on varied surfaces, and consistent control. </li>
                        <li><i class="fas fa-check"></i> Durable compound and tread architecture, inspired by a bold bull motif, built for high wear resistance and long mileage. </li>
                        <li><i class="fas fa-check"></i> Heat-dissipating design elements enable cooler running under sustained high-speed or heavy-load conditions.</li>
                        <li><i class="fas fa-check"></i>Fuel-efficient behavior, combining low rolling resistance with strong traction—aided by optimized block patterns and compound.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2-year standard manufacturer warranty on this tyre, covering manufacturing defects such as radial splits (not from visible impact), ply or bead separation, and workmanship faults. Warranty is assessed pro‑rata based on tread left and physical inspection at Apollo-authorized centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '36',
        inventoryId: 36, // Links to inventory system tire ID
        name: 'Endu Maxx LT HD(LV)-D',
        brand: 'Apollo',
        price: 6787,
        originalPrice: 7197,
        category: 'high-performance',
        description: 'The EnduMaxx LT HD (LV)‑D is a rugged, heavy-duty tubed radial tyre crafted for light trucks and pickups under extreme load and mixed terrain. Its robust tread design delivers exceptional off-road traction and durability, making it ideal for commercial and rural logistics operations. Purpose-built to handle high payloads while maintaining stability, fuel efficiency, and long life. ',
        features: [
            'Heavy-load bead construction offers best‑in‑class structural strength for demanding operations.',
            'All‑terrain tread pattern delivers high puncture resistance, grip on varied surfaces, and consistent control. ',
            'Durable compound and tread architecture, inspired by a bold bull motif, built for high wear resistance and long mileage. ',
            'Heat-dissipating design elements enable cooler running under sustained high-speed or heavy-load conditions.',
            'Fuel-efficient behavior, combining low rolling resistance with strong traction—aided by optimized block patterns and compound. '
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
