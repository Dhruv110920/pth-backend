        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="terra.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Terra BT-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹17,741</span>
                    <span class="original-price" id="originalPrice">₹18,479.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
              The Apollo Terra BT-D is a heavy-duty drive tyre designed for trucks and buses operating on rocky, mixed infrastructure terrains. It features a cut‑and‑chip resistant compound and tough casing construction for durability and high uptime—delivering cost-efficient performance across rough regional haulage routes.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Robust casing with cut‑and‑chip protection: Engineered to resist abrasions, chips, and punctures typical of rocky off-road and mixed terrain.</li>
                        <li><i class="fas fa-check"></i>On‑ & off‑road optimized tread pattern: Designed for rock-solid traction and stability across uneven surfaces. </li>
                        <li><i class="fas fa-check"></i> Hybrid reinforcement in tread: Enhances initial tread mileage and overall tyre longevity.</li>
                        <li><i class="fas fa-check"></i> Stone protector shoulder design: Shields underlying casing layers from impact damage and stone drilling.</li>
                        <li><i class="fas fa-check"></i>Fuel-efficient compound: Offers improved mileage and reduced operating cost per kilometre through enhanced rolling performance.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2‑year standard warranty on its commercial vehicle tyres, including Terra BT‑D. Coverage includes radial splits (without visible external trauma), ply/separation issues, and manufacturing defects. All claims are assessed on a pro‑rated basis, requiring tyre inspection at an authorized center.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '52',
        inventoryId: 52, // Links to inventory system tire ID
        name: 'Terra BT-D',
        brand: 'Apollo',
        price: 17741,
        originalPrice: 18479,
        category: 'high-performance',
        description: 'The Apollo Terra BT-D is a heavy-duty drive tyre designed for trucks and buses operating on rocky, mixed infrastructure terrains. It features a cut‑and‑chip resistant compound and tough casing construction for durability and high uptime—delivering cost-efficient performance across rough regional haulage routes.',
        features: [
            'Robust casing with cut‑and‑chip protection: Engineered to resist abrasions, chips, and punctures typical of rocky off-road and mixed terrain.',
            'On‑ & off‑road optimized tread pattern: Designed for rock-solid traction and stability across uneven surfaces.',
            'Hybrid reinforcement in tread: Enhances initial tread mileage and overall tyre longevity.',
            'Stone protector shoulder design: Shields underlying casing layers from impact damage and stone drilling.',
            'Fuel-efficient compound: Offers improved mileage and reduced operating cost per kilometre through enhanced rolling performance.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
