...
<div class="product-card" data-id="1" data-redirect="m751hl.php" data-name="M751 HL">
    ...
    <button class="add-to-cart-btn">Add to Cart</button>
                    ...
                    <div class="product-card" data-redirect="M725.php" data-name="M725">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹21,367</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 4: Michelin Energy XM2+ -->
                    <div class="product-card" data-redirect="R156.php" data-name="R156">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹21,289</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 5: Bridgestone G611 -->
                    <div class="product-card" data-redirect="G611.php" data-name="G611">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹20,937</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
