        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="xt7.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">XT7 Gold HD-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹15,759</span>
                    <span class="original-price" id="originalPrice">₹16,438.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
              The XT7 Gold HD‑D is a rugged regional drive tyre engineered for heavy-duty truck and bus use. Featuring a balanced lug-tread pattern and reinforced casing, it’s ideal for mixed-route applications, offering high mileage, structural durability, and reliable performance even in challenging terrain.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Robust casing strength—boasts approximately 12–25% higher durability compared to standard grades, making it ideal for tough environments .</li>
                        <li><i class="fas fa-check"></i> Modular Matrix Tread Technology (MMT)—ensures slow and uniform wear, enhancing traction and service life. </li>
                        <li><i class="fas fa-check"></i> Balanced lug-pattern tread—self-cleans, dissipates heat efficiently, and improves grip on mixed surfaces. </li>
                        <li><i class="fas fa-check"></i> Enhanced cord insulation & heat-ageing resistance—optimizes thermal performance at higher speeds and heavy loads .</li>
                        <li><i class="fas fa-check"></i>High retreadability—the durable casing and tread structure supports multiple retreading cycles, ensuring long lifecycle value.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a manufacturer warranty that covers defects in workmanship or materials, such as radial splits (without external damage) and structural faults. Compensation is calculated on a pro‑rata basis using remaining tread depth as the metric, and claims require inspection under the standard Apollo policy.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '51',
        inventoryId: 51, // Links to inventory system tire ID
        name: 'XT7 Gold HD-D',
        brand: 'Apollo',
        price: 15759,
        originalPrice: 16438,
        category: 'high-performance',
        description: 'The XT7 Gold HD‑D is a rugged regional drive tyre engineered for heavy-duty truck and bus use. Featuring a balanced lug-tread pattern and reinforced casing, it’s ideal for mixed-route applications, offering high mileage, structural durability, and reliable performance even in challenging terrain. ',
        features: [
            'Robust casing strength—boasts approximately 12–25% higher durability compared to standard grades, making it ideal for tough environments.',
            'Modular Matrix Tread Technology (MMT)—ensures slow and uniform wear, enhancing traction and service life.',
            'Balanced lug-pattern tread—self-cleans, dissipates heat efficiently, and improves grip on mixed surfaces.',
            'Enhanced cord insulation & heat-ageing resistance—optimizes thermal performance at higher speeds and heavy loads. ',
            'High retreadability—the durable casing and tread structure supports multiple retreading cycles, ensuring long lifecycle value .' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
