    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">VIHAAN RIB-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹8,041</span>
                    <span class="original-price" id="originalPrice">₹8,489.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo Vihaan Rib‑D is a robust tube-type drive tyre designed specifically for small- and medium-class commercial vehicles (SCVs). Featuring a rib-pattern tread, it delivers exceptional steering stability, wear consistency, and mileage—making it ideal for heavy-load haulage in urban and regional environments.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Ribbed tread profile ensures smooth steering, low rolling resistance, and even wear across the contact patch .</li>
                        <li><i class="fas fa-check"></i> High-ply tube-type construction enhances load-bearing capacity and structural strength under demanding operations.</li>
                        <li><i class="fas fa-check"></i> Heat-dissipating compound and reinforced ply promote consistent performance during long-distance, high-torque tasks.</li>
                        <li><i class="fas fa-check"></i> Extra rubber volume in wear zones extends tread life and improves mileage on challenging Indian road surfaces.</li>
                        <li><i class="fas fa-check"></i>Built for heavy-load SCV fleets, combining durability, mileage, and low maintenance needs on regional transport routes . </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2‑year standard manufacturer’s warranty on Vihaan tyres. This covers radial splits (excluding visible external damage), ply or bead separations, and manufacturing defects. Warranty claims are evaluated on a pro‑rated basis, subject to physical inspection at authorised service centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '42',
        inventoryId: 42, // Links to inventory system tire ID
        name: 'VIHAAN RIB-D',
        brand: 'Apollo',
        price: 8041,
        originalPrice: 8489,
        category: 'high-performance',
        description: 'The Apollo Vihaan Rib‑D is a robust tube-type drive tyre designed specifically for small- and medium-class commercial vehicles (SCVs). Featuring a rib-pattern tread, it delivers exceptional steering stability, wear consistency, and mileage—making it ideal for heavy-load haulage in urban and regional environments.',
        features: [
            'Ribbed tread profile ensures smooth steering, low rolling resistance, and even wear across the contact patch .',
            'High-ply tube-type construction enhances load-bearing capacity and structural strength under demanding operations.',
            'Heat-dissipating compound and reinforced ply promote consistent performance during long-distance, high-torque tasks.',
            'Extra rubber volume in wear zones extends tread life and improves mileage on challenging Indian road surfaces.',
            'Built for heavy-load SCV fleets, combining durability, mileage, and low maintenance needs on regional transport routes.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
