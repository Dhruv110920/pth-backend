        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="ts-10.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">BOSS TS 10</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹4,847</span>
                    <span class="original-price" id="originalPrice">₹5,569.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Ascenso BOSS TS 10 is an F‑2 bias‑ply agricultural tyre designed for tractors and field hauling. It features a CCR compound engineered for puncture and cut resistance while delivering extra mileage.
                   A wider centre rib enhances road contact and steering control, making it suitable for both field and road use. 
                   Ascenso backs the tyre with a 5‑year warranty for bias tyres, covering manufacturing defects under defined conditions.

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Wide Centre Rib – Provides excellent road contact and superior steering control.</li>
                        <li><i class="fas fa-check"></i> CCR Compound – Special tread compound ensures high resistance to cuts and punctures.</li>
                        <li><i class="fas fa-check"></i> Bias-Ply Construction – Offers strength and durability for both field and road applications.</li>
                        <li><i class="fas fa-check"></i> Extra Mileage – Designed for long-lasting performance, reducing replacement frequency.</li>
                        <li><i class="fas fa-check"></i> Versatile Use – Ideal for tractors used in agriculture and transport, suitable for varied terrains.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Ascenso offers a 5‑year limited warranty on bias-ply tyres like the BOSS TS 10, covering manufacturing defects only, with no coverage for cuts, punctures, or misuse. The warranty is pro‑rated based on remaining tread depth and age, up to 60 months from purchase. It doesn’t apply to damage caused by external factors or improper use .</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '8',
        inventoryId: 8, // Links to inventory system tire ID
        name: 'BOSS TS 10',
        brand: 'Ascenso',
        price: 4847,
        originalPrice: 5569,
        category: 'high-performance',
        description: 'The Ascenso BOSS TS 10 is an F‑2 bias‑ply agricultural tyre designed for tractors and field hauling. It features a CCR compound engineered for puncture and cut resistance while delivering extra mileage. A wider centre rib enhances road contact and steering control, making it suitable for both field and road use.Ascenso backs the tyre with a 5‑year warranty for bias tyres, covering manufacturing defects under defined conditions.',
        features: [
            'Wide Centre Rib – Provides excellent road contact and superior steering control.',
            'CCR Compound – Special tread compound ensures high resistance to cuts and punctures.',
            'Bias-Ply Construction – Offers strength and durability for both field and road applications.',
            'Extra Mileage – Designed for long-lasting performance, reducing replacement frequency.',
            'Versatile Use – Ideal for tractors used in agriculture and transport, suitable for varied terrains.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
