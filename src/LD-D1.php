        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="LD-D.jpg" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race LD-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹10,691</span>
                    <span class="original-price" id="originalPrice">₹11,217.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                 The Apollo EnduRace LD‑D is a high-performance drive axle tyre built for regional and long-haul operations. It is designed for high load endurance with strong casing construction and optimized tread for consistent mileage and retreadability. Ideal for commercial vehicles running on Indian highways and mixed routes.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High load-bearing capability with reinforced casing.</li>
                        <li><i class="fas fa-check"></i> CTO casing design for better durability and retreading.</li>
                        <li><i class="fas fa-check"></i> Even rubber distribution for uniform tread wear.</li>
                        <li><i class="fas fa-check"></i> Optimized for long-distance and regional transport.</li>
                        <li><i class="fas fa-check"></i>Built to handle rough road conditions with better mileage output.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The EnduRace LD‑D comes with Apollo’s standard warranty in India, covering manufacturing defects such as radial splits (without visible external damage), ply or bead separations, and premature tread wear. Claims are subject to physical inspection and pro-rata adjustment as per company policy.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '34',
        inventoryId: 34, // Links to inventory system tire ID
        name: 'Endu Race LD-D',
        brand: 'Apollo',
        price: 10691,
        originalPrice: 11217,
        category: 'high-performance',
        description: 'The Apollo EnduRace LD‑D is a high-performance drive axle tyre built for regional and long-haul operations. It is designed for high load endurance with strong casing construction and optimized tread for consistent mileage and retreadability. Ideal for commercial vehicles running on Indian highways and mixed routes.',
        features: [
            'High load-bearing capability with reinforced casing. ',
            'CTO casing design for better durability and retreading.',
            'Even rubber distribution for uniform tread wear. ',
            'Optimized for long-distance and regional transport. ',
            'Built to handle rough road conditions with better mileage output.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
