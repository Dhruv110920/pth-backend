        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="R156.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">R156(TL)</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,827</span>
                    <span class="original-price" id="originalPrice">₹22,992.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Bridgestone R156 TL is a premium radial tyre designed for trucks and buses, ideal for regional and highway applications. It offers excellent mileage and wear resistance thanks to its robust tread design and advanced compound. 
                   The tyre features strong shoulder ribs for enhanced stability and even wear. Its tubeless construction ensures better heat dissipation and lower rolling resistance, contributing to improved fuel efficiency. 
                   The R156 is a reliable choice for long-haul performance with durability and comfort.

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High Mileage Tread Compound – Ensures long tyre life and better cost-efficiency.</li>
                        <li><i class="fas fa-check"></i> Tubeless Design – Reduces heat buildup and enhances safety and fuel efficiency.</li>
                        <li><i class="fas fa-check"></i> Optimized Tread Pattern – Provides uniform wear and excellent grip on highways.</li>
                        <li><i class="fas fa-check"></i> Strong Shoulder Ribs – Improves stability, especially under heavy loads.</li>
                        <li><i class="fas fa-check"></i> Reinforced Casing – Enhances durability and allows for multiple retreads.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The Bridgestone R156 TL tyre in India comes with a warranty of up to 5 years from the date of manufacture or 3 years from the date of purchase, whichever comes first. The warranty covers manufacturing defects only and is valid until the tyre reaches the tread wear indicator (TWI). Claims must be made through authorized dealers with a valid invoice.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '4',
        inventoryId: 4, // Links to inventory system tire ID
        name: 'R156(TL)',
        brand: 'Bridgestone',
        price: 20827,
        originalPrice: 22992,
        category: 'high-performance',
        description: 'The Bridgestone R156 TL is a premium radial tyre designed for trucks and buses, ideal for regional and highway applications. It offers excellent mileage and wear resistance thanks to its robust tread design and advanced compound. The tyre features strong shoulder ribs for enhanced stability and even wear. Its tubeless construction ensures better heat dissipation and lower rolling resistance, contributing to improved fuel efficiency. The R156 is a reliable choice for long-haul performance with durability and comfort.',
        features: [
            'High Mileage Tread Compound – Ensures long tyre life and better cost-efficiency.',
            'Tubeless Design – Reduces heat buildup and enhances safety and fuel efficiency.',
            'Optimized Tread Pattern – Provides uniform wear and excellent grip on highways.',
            'Strong Shoulder Ribs – Improves stability, especially under heavy loads.',
            'Reinforced Casing – Enhances durability and allows for multiple retreads.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
