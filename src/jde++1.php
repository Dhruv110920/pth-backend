        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="jde++.jpg" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">JDE++</h1>
                ...
                <div class="product-price">
                    ...
                    <span class="original-price" id="originalPrice">₹20,479.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The JK Tyre JDE ++ is a heavy-duty bias drive tyre developed for regional and long-haul operations. It features a robust lugged tread and enhanced casing, delivering high mileage, strong traction, and excellent load endurance across mixed terrain.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Aggressive lug tread pattern provides strong grip and consistent traction.</li>
                        <li><i class="fas fa-check"></i>Reinforced casing construction supports high payload and extended durability.</li>
                        <li><i class="fas fa-check"></i>Heat-resistant tread formulation for cooler running and reduced wear.</li>
                        <li><i class="fas fa-check"></i>Deep rubber volume promotes high mileage and longer service life.</li>
                        <li><i class="fas fa-check"></i>Retread-capable design, enabling multiple life cycles and cost efficiency.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The JDE ++ is covered under JK Tyre’s standard 3‑year warranty, valid from the date of manufacture or invoice—whichever is earlier—or until tread reaches the Tread Wear Indicator (TWI), whichever comes first.Only the original purchaser is eligible, and the warranty covers manufacturing defects such as casing failure or belt separation, with claims settled on a pro‑rata basis based on remaining tread depth. Road hazards, improper use, wear beyond TWI, or tyres bought from unauthorized sources are not covered. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '63',
        inventoryId: 63, // Links to inventory system tire ID
        name: 'JDE++',
        brand: 'JK',
        price: 18945,
        originalPrice: 20479,
        category: 'high-performance',
        description: 'The JK Tyre JDE ++ is a heavy-duty bias drive tyre developed for regional and long-haul operations. It features a robust lugged tread and enhanced casing, delivering high mileage, strong traction, and excellent load endurance across mixed terrain.',
        features: [
            'Aggressive lug tread pattern provides strong grip and consistent traction.',
            'Reinforced casing construction supports high payload and extended durability.',
            'Heat-resistant tread formulation for cooler running and reduced wear.',
            'Deep rubber volume promotes high mileage and longer service life.',
            'Retread-capable design, enabling multiple life cycles and cost efficiency.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
