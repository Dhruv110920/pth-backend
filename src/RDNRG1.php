        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="RDNRG.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RD NRG</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹19,101</span>
                    <span class="original-price" id="originalPrice">₹19,836.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The EnduRace RD nRG is a regional/long‑haul drive tyre engineered to deliver best‑in‑class fuel efficiency (saving around 5‑8%) without compromising durability or mileage. Its optimized 4‑block tread design and low-resistance compound enable cool running and consistent performance. The tension‑optimized carcass and robust belt/bead package ensure retreadability and load handling suited for Indian road conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> 2Fuel‑efficient tread design with optimized shoulder blocks connected by tie-bars to reduce rolling resistance.</li>
                        <li><i class="fas fa-check"></i> Cool-running compound developed to minimize heat build-up and lower the rolling resistance coefficient (RRC).</li>
                        <li><i class="fas fa-check"></i> Durable casing (ACTO multi-life) engineered for multiple retreads, extending tyre life.</li>
                        <li><i class="fas fa-check"></i> Robust belt and bead architecture with tension-optimized carcass, for improved longevity and stability under load.</li>
                        <li><i class="fas fa-check"></i> Even tread wear via 4-block footprint, ensuring full rubber usage and predictable mileages.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo offers a 2‑year manufacturer’s warranty on all its commercial vehicle tyres, including this model. The warranty covers faults such as radial splits (without visible external damage), ply or bead separation, and manufacturing defects. Claims are assessed on a pro‑rata basis and require inspection as per Apollo’s standard policy.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '22',
        inventoryId: 22, // Links to inventory system tire ID
        name: 'Endu Race RD NRG',
        brand: 'Apollo',
        price: 19101,
        originalPrice: 19836,
        category: 'high-performance',
        description: 'The EnduRace RD nRG is a regional/long‑haul drive tyre engineered to deliver best‑in‑class fuel efficiency (saving around 5‑8%) without compromising durability or mileage. Its optimized 4‑block tread design and low-resistance compound enable cool running and consistent performance. The tension‑optimized carcass and robust belt/bead package ensure retreadability and load handling suited for Indian road conditions.',
        features: [
            'Fuel‑efficient tread design with optimized shoulder blocks connected by tie-bars to reduce rolling resistance.',
            'Cool-running compound developed to minimize heat build-up and lower the rolling resistance coefficient (RRC).',
            'Durable casing (ACTO multi-life) engineered for multiple retreads, extending tyre life.',
            'Robust belt and bead architecture with tension-optimized carcass, for improved longevity and stability under load.',
            'Even tread wear via 4-block footprint, ensuring full rubber usage and predictable mileages.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
