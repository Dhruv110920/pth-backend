...
<div class="dropdown-content">
  <a href="bridgestone1.php">Bridgestone</a>
  <a href="michlen1.php">Michelin</a>
  <a href="ascenso1.php">Ascenso</a>
  <a href="apollo1.php">Apollo</a>
  <a href="jk1.php">JK</a>
</div>
    ...
    <div class="slide first-slide" style="background-image: url('m751hl.jpg');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="m751hl1.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('R271.jpg');">
      <div class="slide-overlay">
        <div class="slide-content">
         ...
         <a href="R2711.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide third-slide" style="background-image: url('R156.png');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="R1561.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('enduld.jpg');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="LD1.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('X\ Multi\ Z2.jpg');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="Z21.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('X\ Multi\ Z+.jpg');">
      <div class="slide-overlay">
        <div class="slide-content">
         ...
         <a href="Z+1.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('X\ Multi\ D+.png');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="D+1.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('td16.jpeg');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="td-161.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="slide second-slide" style="background-image: url('TR\ 21.png');">
      <div class="slide-overlay">
        <div class="slide-content">
          ...
          <a href="211.php" class="Enquiry-btn">Enquire Now</a>
        </div>
      </div>
    </div>
  </div>
