...
<div class="product-card" data-id="17" data-redirect="LD1.php" data-name="Endu Race LD">
    ...
    <div class="product-price">₹20,312</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: Endu Race RD HD -->
                    <div class="product-card" data-id="18" data-redirect="RDHD1.php" data-name="Endu Race RD HD">
                        <div class="product-image">
                    ...
                    <div class="product-card" data-id="19" data-redirect="ED1.php" data-name="Endu Race ED">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹18,945</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 4: Endu Race RA -->
                    <div class="product-card" data-id="20" data-redirect="RA1.php" data-name="Endu Race RA">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹18,906</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 5: Endu Race RA NRG -->
                    <div class="product-card" data-id="21" data-redirect="NRG1.php" data-name="Endu Race RA NRG">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹18,672</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 6: Endu Race RD NRG -->
                    <div class="product-card" data-id="22" data-redirect="RDNRG1.php" data-name="Endu Race RD NRG">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19,101</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 7: Endu Race RA(T) -->
                    <div class="product-card" data-id="23" data-redirect="RA(T)1.php" data-name="Endu Race RA(T)">
                        <div class="product-image">
                    ...
                    <div class="product-card" data-id="24" data-redirect="LHD1.php" data-name="Endu Mile LHD">
                        <div class="product-image">
                    ...
                    <div class="product-card" data-id="25" data-redirect="MA1.php" data-name="Endu Trax MA">
                        <div class="product-image">
                    ...
                    <div class="product-card" data-id="26" data-redirect="MD+1.php" data-name="Endu Trax MD+">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹20,195</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>  
                    <!-- Product 11: Endu Race LD+ -->
                    <div class="product-card" data-id="27" data-redirect="LD+1.php" data-name="Endu Race LD+">
                        <div class="product-image">
                            <img src="LD+.png" alt="Endu Race LD+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹16,172</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 12: Endu Race RA -->
                    <div class="product-card" data-id="28" data-redirect="r1.php" data-name="Endu Race RA">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Endu Race RA </div>
                        <div class="product-specs">9.00 R20</div>
                        <div class="product-price">₹15,391</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 13: Endu Race LD -->
                    <div class="product-card" data-id="29" data-redirect="l1.php" data-name="Endu Race LD">
                        <div class="product-image">
                            <img src="LD.png" alt="Endu Race LD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹14,453</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 14: Endu Race RA -->
                    <div class="product-card" data-id="30" data-redirect="A1.php" data-name="Endu Race RA">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Endu Race RA</div>
                        <div class="product-specs">8.25 R20</div>
                        <div class="product-price">₹13,594</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 15: Endu Trax MD -->
                    <div class="product-card" data-id="31" data-redirect="MD1.php" data-name="Endu Trax MD">
                        <div class="product-image">
                            <img src="MD.png" alt="Endu Trax MD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹21,719</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 16: Endu Trax MA -->
                    <div class="product-card" data-id="32" data-redirect="m1.php" data-name="Endu Trax MA">
                        <div class="product-image">
                            <img src="MA.png" alt="Endu Trax MA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Endu Trax MA</div>
                        <div class="product-specs">11.00 R20</div>
                        <div class="product-price">₹20,664</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 17: Endu Race RA(N) TL-D -->
                    <div class="product-card" data-id="33" data-redirect="TL-D1.php" data-name="Endu Race RA(N) TL-D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹11,713</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 18: Endu Race LD-D -->
                    <div class="product-card" data-id="34" data-redirect="LD-D1.php" data-name="Endu Race LD-D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹10,691</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 19: Endu Race RA-D -->
                    <div class="product-card" data-id="35" data-redirect="RA-D1.php" data-name="Endu Race RA-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">8.25 R16</div>
                        <div class="product-price">₹10,498</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 20:Endu Maxx LT HD(LV)-D -->
                    <div class="product-card" data-id="36" data-redirect="LTHD1.php" data-name="Endu Maxx LT HD(LV)-D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹6,787</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 21: VIHAAN LUG (SV)-D -->
                    <div class="product-card" data-id="37" data-redirect="LUG1.php" data-name="VIHAAN LUG (SV)-D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹6,258</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 22: VIHAAN RIB (SV)-D -->
                    <div class="product-card" data-id="38" data-redirect="RIB1.php" data-name="VIHAAN RIB (SV)-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">7.00-15</div>
                        <div class="product-price">₹5,384</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 23: VIHAAN LUG (SV)-D -->
                    <div class="product-card" data-id="39" data-redirect="LUG1.php" data-name="VIHAAN LUG (SV)-D">
                        <div class="product-image">
                            <img src="lug.png" alt="VIHAAN LUG (SV)-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                    ...
                    <div class="product-card" data-id="40" data-redirect="LUG-D1.php" data-name="VIHAAN LUG-D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹9,157</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 25: VIHAAN LUG HD-D -->
                    <div class="product-card" data-id="41" data-redirect="LUGHD-D1.php" data-name="VIHAAN LUG HD-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">8.25-16</div>
                        <div class="product-price">₹9,380</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 26: VIHAAN RIB-D -->
                    <div class="product-card" data-id="42" data-redirect="RIB-D1.php" data-name="VIHAAN RIB-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">8.25-16</div>
                        <div class="product-price">₹8,041</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 27: Endu Comfort CA2 -->
                    <div class="product-card" data-id="43" data-redirect="CA21.php" data-name="Endu Comfort CA2">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹19,440</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 28: Endu Race RA(N) -->
                    <div class="product-card" data-id="44" data-redirect="RA(N)1.php" data-name="Endu Race RA(N)">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹19,156</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 29: Endu Race RD -->
                    <div class="product-card" data-id="45" data-redirect="RD1.php" data-name="Endu Race RD">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹20,042</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 30: XT7 Gold HD-D -->
                    <div class="product-card" data-id="46" data-redirect="XT71.php" data-name="XT7 Gold HD-D">
                        <div class="product-image">
                        ...
                        <div class="product-price">₹13,273</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 31: Amar Gold-D -->
                    <div class="product-card" data-id="47" data-redirect="Amar1.php" data-name="Amar Gold-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">9.00-20</div>
                        <div class="product-price">₹12,337</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 32: XT7 Gold HD-D -->
                    <div class="product-card" data-id="48" data-redirect="XT7-D1.php" data-name="XT7 Gold HD-D">
                        <div class="product-image">
                            <img src="xt7.png" alt="XT7 Gold HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹12,080</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 33: Amar Gold-D -->
                    <div class="product-card" data-id="49" data-redirect="Amar-D1.php" data-name="Amar Gold-D">
                        <div class="product-image">
                            <img src="amar.webp" alt="Amar Gold-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Amar Gold-D</div>
                        <div class="product-specs">8.25-20</div>
                        <div class="product-price">₹10,269</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 34: Amar Gold-D -->
                    <div class="product-card" data-id="50" data-redirect="r-D1.php" data-name="Amar Gold-D">
                        <div class="product-image">
                            <img src="amar.webp" alt="Amar Gold-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹14,235</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 35: XT7 Gold HD-D -->
                    <div class="product-card" data-id="51" data-redirect="7-d1.php" data-name="XT7 Gold HD-D">
                        <div class="product-image">
                            <img src="xt7.png" alt="XT7 Gold HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-price">₹15,759</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 36: Terra BT-D -->
                    <div class="product-card" data-id="52" data-redirect="Terra1.php" data-name="Terra BT-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹17,741</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 37: Amar Deluxe X-D -->
                    <div class="product-card" data-id="53" data-redirect="Deluxe1.php" data-name="Amar Deluxe X-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹13,565</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 38: XT 100 HD X-D -->
                    <div class="product-card" data-id="54" data-redirect="XT1.php" data-name="XT 100 HD X-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹15,131</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 39: Haulug X-D -->
                    <div class="product-card" data-id="55" data-redirect="Haulug1.php" data-name="Haulug X-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹14,508</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 40: XT9 Gold-D -->
                    <div class="product-card" data-id="56" data-redirect="XT91.php" data-name="XT9 Gold-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/95 D20</div>
                        <div class="product-price">₹15,144</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 41: XT-100 HD-D -->
                    <div class="product-card" data-id="57" data-redirect="XT-1001.php" data-name="XT-100 HD-D">
                        <div class="product-image">
                        ...
                        <div class="product-specs">295/95 D20</div>
                        <div class="product-price">₹15,748</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
...
<div class="footer-column">
    <h4>Quick Links</h4>
    <p><a href="frontage.php">Home</a></p>
