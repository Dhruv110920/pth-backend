        ...
        <main>
            ...
            <section class="products-section" id="productsSection">
                ...
                <div class="products-grid" id="productsGrid">
                    ...
                    <!-- Product 1: Endu Race LD -->
<div class="product-card" data-id="17" data-redirect="LD.php" data-name="Endu Race LD">
    <div class="product-image">
        <img src="LD.png" alt="Endu Race LD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
        <div class="product-image-placeholder" style="display: none;">🛞</div>
    </div>
    <div class="product-brand">Apollo</div>
    <div class="product-name">Endu Race LD(s)</div>
    <div class="product-specs">295/90 R 20</div>
    <div class="product-price">₹20,625</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: Endu Race RD HD -->
                    <div class="product-card" data-id="18" data-redirect="RDHD.php" data-name="Endu Race RD HD">
                        <div class="product-image">
                            <img src="RDHD.png" alt="Endu Race RD HD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RD HD</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹20,703</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 3: Endu Race ED -->
                    <div class="product-card" data-id="19" data-redirect="ED.php" data-name="Endu Race ED">
                        <div class="product-image">
                            <img src="ED.png" alt="Endu Race ED" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race ED</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19,141</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 4: Endu Race RA -->
                    <div class="product-card" data-id="20" data-redirect="RA.php" data-name="Endu Race RA">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RA</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19,062</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 5: Endu Race RA NRG -->
                    <div class="product-card" data-id="21" data-redirect="NRG.php" data-name="Endu Race RA NRG">
                        <div class="product-image">
                            <img src="NRG.png" alt="Endu Race RA NRG" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RA NRG</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹18,828</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 6: Endu Race RD NRG -->
                    <div class="product-card" data-id="22" data-redirect="RDNRG.php" data-name="Endu Race RD NRG">
                        <div class="product-image">
                            <img src="RDNRG.png" alt="Endu Race RD NRG" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RD NRG</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19,258</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 7: Endu Race RA(T) -->
                    <div class="product-card" data-id="23" data-redirect="RA(T).php" data-name="Endu Race RA(T)">
                        <div class="product-image">
                            <img src="RA(T).png" alt="Endu Race RA(T)" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RA(T)</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19297</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 8: Endu Mile LHD -->
                    <div class="product-card" data-id="24" data-redirect="LHD.php" data-name="Endu Mile LHD">
                        <div class="product-image">
                            <img src="LHD.png" alt="Endu Mile LHD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Mile LHD</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹20,156</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 9: Endu Trax MA -->
                    <div class="product-card" data-id="25" data-redirect="MA.php" data-name="Endu Trax MA">
                        <div class="product-image">
                            <img src="MA.png" alt="Endu Trax MA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Trax MA</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹18,828</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 10: Endu Trax MD+ -->
                    <div class="product-card" data-id="26" data-redirect="MD+.php" data-name="Endu Trax MD+">
                        <div class="product-image">
                            <img src="MD+.png" alt="Endu Trax MD+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Trax MD+</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹20,351</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>  
                    <!-- Product 11: Endu Race LD+ -->
                    <div class="product-card" data-id="27" data-redirect="LD+.php" data-name="Endu Race LD+">
                        <div class="product-image">
                            <img src="LD+.png" alt="Endu Race LD+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race LD+</div>
                        <div class="product-specs">9.00 R20</div>
                        <div class="product-price">₹16,328</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 12: Endu Race RA -->
                    <div class="product-card" data-id="28" data-redirect="r.php" data-name="Endu Race RA">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Endu Race RA </div>
                        <div class="product-specs">9.00 R20</div>
                        <div class="product-price">₹15,547</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 13: Endu Race LD -->
                    <div class="product-card" data-id="29" data-redirect="l.php" data-name="Endu Race LD">
                        <div class="product-image">
                            <img src="LD.png" alt="Endu Race LD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race LD</div>
                        <div class="product-specs">8.25 R20</div>
                        <div class="product-price">₹14,609</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 14: Endu Race RA -->
                    <div class="product-card" data-id="30" data-redirect="A.php" data-name="Endu Race RA">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Endu Race RA</div>
                        <div class="product-specs">8.25 R20</div>
                        <div class="product-price">₹13,750</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 15: Endu Trax MD -->
                    <div class="product-card" data-id="31" data-redirect="MD.php" data-name="Endu Trax MD">
                        <div class="product-image">
                            <img src="MD.png" alt="Endu Trax MD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Trax MD</div>
                        <div class="product-specs">11.00 R20</div>
                        <div class="product-price">₹21,875</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 16: Endu Trax MA -->
                    <div class="product-card" data-id="32" data-redirect="m.php" data-name="Endu Trax MA">
                        <div class="product-image">
                            <img src="MA.png" alt="Endu Trax MA" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Endu Trax MA</div>
                        <div class="product-specs">11.00 R20</div>
                        <div class="product-price">₹20,820</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 17: Endu Race RA(N) TL-D -->
                    <div class="product-card" data-id="33" data-redirect="TL-D.php" data-name="Endu Race RA(N) TL-D">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA(N) TL-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Rance RA(N) TL-D</div>
                        <div class="product-specs">235/75 R17.5</div>
                        <div class="product-price">₹11,913</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 18: Endu Race LD-D -->
                    <div class="product-card" data-id="34" data-redirect="LD-D.php" data-name="Endu Race LD-D">
                        <div class="product-image">
                            <img src="LD-D.jpg" alt="Endu Race LD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Rance LD-D</div>
                        <div class="product-specs">8.25 R16</div>
                        <div class="product-price">₹10891</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 19: Endu Race RA-D -->
                    <div class="product-card" data-id="35" data-redirect="RA-D.php" data-name="Endu Race RA-D">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Rance RA-D</div>
                        <div class="product-specs">8.25 R16</div>
                        <div class="product-price">₹10,698</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 20:Endu Maxx LT HD(LV)-D -->
                    <div class="product-card" data-id="36" data-redirect="LTHD.php" data-name="Endu Maxx LT HD(LV)-D">
                        <div class="product-image">
                            <img src="LTHD.png" alt="Endu Maxx LT HD(LV)-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Maxx LT HD(LV)-D</div>
                        <div class="product-specs">7.00 R15</div>
                        <div class="product-price">₹6,987</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                       <!-- Product 21: VIHAAN LUG (SV)-D -->
                    <div class="product-card" data-id="37" data-redirect="LUG.php" data-name="VIHAAN LUG (SV)-D">
                        <div class="product-image">
                            <img src="lug.png" alt="VIHAAN LUG (SV)-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">VIHAAN LUG (SV)-D</div>
                        <div class="product-specs">7.00-15</div>
                        <div class="product-price">₹6,458</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 22: VIHAAN RIB (SV)-D -->
                    <div class="product-card" data-id="38" data-redirect="RIB.php" data-name="VIHAAN RIB (SV)-D">
                        <div class="product-image">
                            <img src="rib.png" alt="VIHAAN RIB (SV)-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">VIHAAN RIB (SV)-D</div>
                        <div class="product-specs">7.00-15</div>
                        <div class="product-price">₹5,584</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 23: VIHAAN LUG (SV)-D -->
                    <div class="product-card" data-id="39" data-redirect="LUG.php" data-name="VIHAAN LUG (SV)-D">
                        <div class="product-image">
                            <img src="lug.png" alt="VIHAAN LUG (SV)-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                      ...
                      <!-- Product 24: VIHAAN LUG-D -->
                    <div class="product-card" data-id="40" data-redirect="LUG-D.php" data-name="VIHAAN LUG-D">
                        <div class="product-image">
                            <img src="lug.png" alt="VIHAAN LUG-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">VIHAAN LUG-D</div>
                        <div class="product-specs">8.25-16</div>
                        <div class="product-price">₹9357</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 25: VIHAAN LUG HD-D -->
                    <div class="product-card" data-id="41" data-redirect="LUGHD-D.php" data-name="VIHAAN LUG HD-D">
                        <div class="product-image">
                            <img src="lug.png" alt="VIHAAN LUG HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">VIHAAN LUG HD-D</div>
                        <div class="product-specs">8.25-16</div>
                        <div class="product-price">₹9,580</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 26: VIHAAN RIB-D -->
                    <div class="product-card" data-id="42" data-redirect="RIB-D.php" data-name="VIHAAN RIB-D">
                        <div class="product-image">
                            <img src="rib.png" alt="VIHAAN RIB-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">VIHAAN RIB-D</div>
                        <div class="product-specs">8.25-16</div>
                        <div class="product-price">₹8,241</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 27: Endu Comfort CA2 -->
                    <div class="product-card" data-id="43" data-redirect="CA2.php" data-name="Endu Comfort CA2">
                        <div class="product-image">
                            <img src="ca2.png" alt="Endu Comfort CA2" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Comfort CA2</div>
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹19,640</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 28: Endu Race RA(N) -->
                    <div class="product-card" data-id="44" data-redirect="RA(N).php" data-name="Endu Race RA(N)">
                        <div class="product-image">
                            <img src="RA.png" alt="Endu Race RA(N)" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RA(N)</div>
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹19,356</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 29: Endu Race RD -->
                    <div class="product-card" data-id="45" data-redirect="RD.php" data-name="Endu Race RD">
                        <div class="product-image">
                            <img src="rd.png" alt="Endu Race RD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Endu Race RD</div>
                        <div class="product-specs">295/80 R22.5</div>
                        <div class="product-price">₹20,242</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    <!-- Product 30: XT7 Gold HD-D -->
                    <div class="product-card" data-id="46" data-redirect="XT7.php" data-name="XT7 Gold HD-D">
                        <div class="product-image">
                            <img src="xt7.png" alt="XT7 Gold HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">XT7 Gold HD-D</div>
                        <div class="product-specs">9.00-20</div>
                        <div class="product-price">₹13,473</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 31: Amar Gold-D -->
                    <div class="product-card" data-id="47" data-redirect="Amar.php" data-name="Amar Gold-D">
                        <div class="product-image">
                            <img src="amar.webp" alt="Amar Gold-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Amar Gold-D</div>
                        <div class="product-specs">9.00-20</div>
                        <div class="product-price">₹12,537</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 32: XT7 Gold HD-D -->
                    <div class="product-card" data-id="48" data-redirect="XT7-D.php" data-name="XT7 Gold HD-D">
                        <div class="product-image">
                            <img src="xt7.png" alt="XT7 Gold HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">XT7 Gold HD-D</div>
                        <div class="product-specs">8.25-20</div>
                        <div class="product-price">₹12,280</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 33: Amar Gold-D -->
                    <div class="product-card" data-id="49" data-redirect="Amar-D.php" data-name="Amar Gold-D">
                        <div class="product-image">
                            <img src="amar.webp" alt="Amar Gold-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        ...
                        <div class="product-name">Amar Gold-D</div>
                        <div class="product-specs">8.25-20</div>
                        <div class="product-price">₹10,469</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 34: Amar Gold-D -->
                    <div class="product-card" data-id="50" data-redirect="r-D.php" data-name="Amar Gold-D">
                        <div class="product-image">
                            <img src="amar.webp" alt="Amar Gold-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Amar Gold-D</div>
                        <div class="product-specs">295/95 D20</div>
                        <div class="product-price">₹14,435</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 35: XT7 Gold HD-D -->
                    <div class="product-card" data-id="51" data-redirect="7-d.php" data-name="XT7 Gold HD-D">
                        <div class="product-image">
                            <img src="xt7.png" alt="XT7 Gold HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">XT7 Gold HD-D</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹15,959</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 36: Terra BT-D -->
                    <div class="product-card" data-id="52" data-redirect="Terra.php" data-name="Terra BT-D">
                        <div class="product-image">
                            <img src="terra.png" alt="Terra BT-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Terra BT-D</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹17,940</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 37: Amar Deluxe X-D -->
                    <div class="product-card" data-id="53" data-redirect="Deluxe.php" data-name="Amar Deluxe X-D">
                        <div class="product-image">
                            <img src="deluxe.png" alt="Amar Deluxe X-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Amar Deluxe X-D</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹13,765</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 38: XT 100 HD X-D -->
                    <div class="product-card" data-id="54" data-redirect="XT.php" data-name="XT 100 HD X-D">
                        <div class="product-image">
                            <img src="xt100.png" alt="XT 100 HD X-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">XT 100 HD X-D</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹15,331</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                     <!-- Product 39: Haulug X-D -->
                    <div class="product-card" data-id="55" data-redirect="Haulug.php" data-name="Haulug X-D">
                        <div class="product-image">
                            <img src="haulage.png" alt="Haulug X-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">Haulug X-D</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹14,708</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 40: XT9 Gold-D -->
                    <div class="product-card" data-id="56" data-redirect="XT9.php" data-name="XT9 Gold-D">
                        <div class="product-image">
                            <img src="xt9.png" alt="XT9 Gold-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">XT9 Gold-D</div>
                        <div class="product-specs">295/95 D20</div>
                        <div class="product-price">₹15,344</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                      <!-- Product 41: XT-100 HD-D -->
                    <div class="product-card" data-id="57" data-redirect="XT-100.php" data-name="XT-100 HD-D">
                        <div class="product-image">
                            <img src="xt100.png" alt="XT-100 HD-D" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">Apollo</div>
                        <div class="product-name">XT-100 HD-D</div>
                        <div class="product-specs">295/95 D20</div>
                        <div class="product-price">₹15,948</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
