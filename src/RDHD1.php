        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="RDHD.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Endu Race RDHD</h1>
                ...
                <div class="product-price">
                    ...
                    <span class="original-price" id="originalPrice">₹21,324.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The EnduRace RD HD is a heavy-duty regional drive radial tyre designed for trucks and buses operating on mixed road conditions. It features a hexagonal block tread pattern and a stress-optimized carcass, offering 25% higher casing strength, improved traction, and longer life. The tyre is engineered for multiple retreads, helping reduce total cost of ownership while ensuring consistent performance in all seasons.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> 25% Higher Casing Strength – Built to handle demanding regional haulage.</li>
                        <li><i class="fas fa-check"></i> Hexagonal Block Tread Pattern – Improves grip and tread stability on varied surfaces.</li>
                        <li><i class="fas fa-check"></i> Stress-Limited Carcass Design – Reduces casing failures and enhances durability.</li>
                        <li><i class="fas fa-check"></i> Retreadable Structure – Supports multiple retreads for better cost efficiency.</li>
                        <li><i class="fas fa-check"></i> All-Season Performance – Designed for reliable traction in diverse weather and terrain conditions.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>the Apollo EnduRace RD HD tyre is covered under Apollo’s standard limited warranty, which protects against manufacturing defects for up to 2 years from the date of purchase or until 50% tread wear, whichever occurs first. If a tyre becomes unserviceable within this period, customers may receive a pro-rata replacement or credit based on the remaining tread depth. To claim the warranty, the tyre must be registered within 30 days of purchase and submitted along with the original invoice through an authorized Apollo dealer. The warranty does not cover damage due to misuse, overloading, or external factors.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '18',
        inventoryId: 18, // Links to inventory system tire ID
        name: 'Endu Race RDHD',
        brand: 'Apollo',
        price: 20312,
        originalPrice: 21324,
        category: 'high-performance',
        description: 'The EnduRace RD HD is a heavy-duty regional drive radial tyre designed for trucks and buses operating on mixed road conditions. It features a hexagonal block tread pattern and a stress-optimized carcass, offering 25% higher casing strength, improved traction, and longer life. The tyre is engineered for multiple retreads, helping reduce total cost of ownership while ensuring consistent performance in all seasons.',
        features: [
            '25% Higher Casing Strength – Built to handle demanding regional haulage.',
            'Hexagonal Block Tread Pattern – Improves grip and tread stability on varied surfaces.',
            'Stress-Limited Carcass Design – Reduces casing failures and enhances durability.',
            'Retreadable Structure – Supports multiple retreads for better cost efficiency.',
            'All-Season Performance – Designed for reliable traction in diverse weather and terrain conditions.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
