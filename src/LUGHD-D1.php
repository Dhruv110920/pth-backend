    ...
    <div class="product-container">
        ...
        <div class="product-content">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">VIHAAN LUG HD-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹9,380</span>
                    <span class="original-price" id="originalPrice">₹9,867.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
               The Apollo Vihaan Lug HD‑D is a heavy-duty, tube‑type drive tyre tailored for light and small commercial vehicles (SCVs and light LCVs). It features a robust lug‑tread pattern and rugged construction that supports high payloads over long distances—delivering traction, structural strength, and consistent performance.  
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Heavy-duty lug-pattern tread ensures deep traction and self-cleaning on rough or mixed urban/regional route surfaces.</li>
                        <li><i class="fas fa-check"></i> High‑ply tube-type build (typically 18 PR) for superior load endurance and structural integrity under heavy use.</li>
                        <li><i class="fas fa-check"></i> Noise-optimized design enabling quieter straight-line stability and better driver comfort.</li>
                        <li><i class="fas fa-check"></i> Fuel-efficient performance helps reduce tyre costs per kilometre, enhancing fleet economy.</li>
                        <li><i class="fas fa-check"></i>Enhanced handling stability under load thanks to reinforced shoulder construction and tread rigidity.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2‑year manufacturer’s warranty covering defects such as material or workmanship faults, radial splits (unrelated to visible impact), and ply/bead failures. Claims are pro‑rated and processed after inspection at authorized Apollo service centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '41',
        inventoryId: 41, // Links to inventory system tire ID
        name: 'VIHAAN LUG HD-D',
        brand: 'Apollo',
        price: 9380,
        originalPrice: 9867,
        category: 'high-performance',
        description: 'The Apollo Vihaan Lug HD‑D is a heavy-duty, tube‑type drive tyre tailored for light and small commercial vehicles (SCVs and light LCVs). It features a robust lug‑tread pattern and rugged construction that supports high payloads over long distances—delivering traction, structural strength, and consistent performance.',
        features: [
            'Heavy-duty lug-pattern tread ensures deep traction and self-cleaning on rough or mixed urban/regional route surfaces.',
            'High‑ply tube-type build (typically 18 PR) for superior load endurance and structural integrity under heavy use. ',
            'Noise-optimized design enabling quieter straight-line stability and better driver comfort.',
            'Fuel-efficient performance helps reduce tyre costs per kilometre, enhancing fleet economy.',
            'Enhanced handling stability under load thanks to reinforced shoulder construction and tread rigidity.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
