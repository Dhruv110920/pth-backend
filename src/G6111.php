        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="G611.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">G611</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹20,085</span>
                    <span class="original-price" id="originalPrice">₹23,372.00</span>
                    <span class="discount-badge">17% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                   The Bridgestone G611 is a premium commercial tyre designed specifically for trailer axle applications. It offers excellent durability and wear resistance, making it ideal for long hauls and heavy loads. 
                   Its optimized tread pattern ensures uniform wear and improved fuel efficiency. 
                   The G611 also provides enhanced stability and control, even under high-load conditions. It's a trusted choice for fleet operators seeking long-lasting performance and reliability.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High Load Durability – Built for trailer axle applications with strong carcass construction to handle heavy loads.</li>
                        <li><i class="fas fa-check"></i> Uniform Tread Wear – Special tread design helps reduce irregular wear for longer tyre life.</li>
                        <li><i class="fas fa-check"></i> Fuel Efficiency – Low rolling resistance contributes to better mileage and lower fuel consumption.</li>
                        <li><i class="fas fa-check"></i> Enhanced Traction & Stability – Optimized tread pattern offers better grip and directional stability.</li>
                        <li><i class="fas fa-check"></i> Retreadability – Durable casing allows for multiple retreads, maximizing value over time.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The Bridgestone G611 tyre in India comes with a standard warranty covering manufacturing defects only, valid for 5 years from the date of manufacture or 3 years from purchase, whichever is earlier. It does not qualify for Bridgestone's unconditional warranty. Damages like cuts, punctures, or road hazards are not covered. Claims are processed on a pro-rata basis based on tread wear.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '1',
        inventoryId: 1, // Links to inventory system tire ID
        name: 'M751 HL',
        brand: 'Bridgestone',
        price: 20085,
        originalPrice: 23372,
        category: 'high-performance',
        description: 'The Bridgestone G611 is a premium commercial tyre designed specifically for trailer axle applications. It offers excellent durability and wear resistance, making it ideal for long hauls and heavy loads. Its optimized tread pattern ensures uniform wear and improved fuel efficiency. The G611 also provides enhanced stability and control, even under high-load conditions. Its a trusted choice for fleet operators seeking long-lasting performance and reliability.',
        features: [
            'High Load Durability – Built for trailer axle applications with strong carcass construction to handle heavy loads.',
            'Uniform Tread Wear – Special tread design helps reduce irregular wear for longer tyre life.',
            'Fuel Efficiency – Low rolling resistance contributes to better mileage and lower fuel consumption.',
            'Enhanced Traction & Stability – Optimized tread pattern offers better grip and directional stability.',
            'Retreadability – Durable casing allows for multiple retreads, maximizing value over time.'
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
