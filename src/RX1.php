        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="Rxtra.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">Jet R Xtra Miles</h1>
                ...
                <div class="product-price">
                    ...
                    <span class="original-price" id="originalPrice">₹15,217.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
             Jet R Xtra Miles by JK Tyre is engineered for long-haul trucks, offering superior mileage, uniform tread wear, and enhanced fuel efficiency. Its robust construction ensures better casing life and retreadability, making it ideal for highway and regional operations in Indian conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>High mileage compound for extended tyre life.</li>
                        <li><i class="fas fa-check"></i>Strong casing for multiple retreads.</li>
                        <li><i class="fas fa-check"></i>Uniform tread wear ensures smoother rides.</li>
                        <li><i class="fas fa-check"></i> Optimized tread pattern for better grip and traction.</li>
                        <li><i class="fas fa-check"></i>Ideal for highway and mixed road operations</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Covered under JK Tyre’s standard 3-year warranty from the date of manufacture or purchase, whichever is earlier. Warranty is applicable only for original owners and covers manufacturing defects like casing issues or premature tread wear. Claims are handled on a pro-rata basis as per company policy.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '59',
        inventoryId: 59, // Links to inventory system tire ID
        name: 'Jet R Xtra Miles',
        brand: 'JK',
        price: 14492,
        originalPrice: 15217,
        category: 'high-performance',
        description: 'Jet R Xtra Miles by JK Tyre is engineered for long-haul trucks, offering superior mileage, uniform tread wear, and enhanced fuel efficiency. Its robust construction ensures better casing life and retreadability, making it ideal for highway and regional operations in Indian conditions.',
        features: [
            'High mileage compound for extended tyre life.',
            'Strong casing for multiple retreads.',
            'Uniform tread wear ensures smoother rides.',
            'Optimized tread pattern for better grip and traction.',
            'Ideal for highway and mixed road operations.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
