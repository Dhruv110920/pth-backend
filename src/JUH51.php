        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="juh5.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">JUH 5</h1>
                <p class="product-brand" id="productBrand">JK</p>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹17,969</span>
                    <span class="original-price" id="originalPrice">₹19,296.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
             The JK Tyre JUH 5 is a high‑mileage radial rib tyre designed for vehicle‑carrier and mixed‑load applications. It features straight grooves, centre stone ejectors, and advanced siping for enhanced grip, uniform wear, and reduced chunking. Built with a strong belt package, it supports multiple retreads and extended service life.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Unique rib tread with lateral sipes for superior handling and uniform wear.</li>
                        <li><i class="fas fa-check"></i>Stone ejectors in centre grooves minimize stone retention and reduce chunking or damage. </li>
                        <li><i class="fas fa-check"></i>Robust high-strength belt construction designed for multiple retreading and structural resilience.</li>
                        <li><i class="fas fa-check"></i>Straight groove architecture enhances wet traction and steering stability on roads.</li>
                        <li><i class="fas fa-check"></i>Optimized contact patch and tread design for long life and consistent performance across steer and drive axles . </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>In India, JUH 5 is backed by JK Tyre’s 3‑year warranty from the date of purchase or manufacturing—or until the tread reaches the Tread Wear Indicator (TWI), whichever is earlier. It covers manufacturing defects like casing separation or belt failures and is valid only for the original purchaser. Claims are handled pro‑rata based on remaining tread; wear beyond TWI, road damage, misuse, or unauthorized purchase channels are excluded. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '62',
        inventoryId: 62, // Links to inventory system tire ID
        name: 'JUH 5',
        brand: 'JK',
        price: 17969,
        originalPrice: 19296,
        category: 'high-performance',
        description: 'The JK Tyre JUH 5 is a high‑mileage radial rib tyre designed for vehicle‑carrier and mixed‑load applications. It features straight grooves, centre stone ejectors, and advanced siping for enhanced grip, uniform wear, and reduced chunking. Built with a strong belt package, it supports multiple retreads and extended service life.',
        features: [
            'Unique rib tread with lateral sipes for superior handling and uniform wear.',
            'Stone ejectors in centre grooves minimize stone retention and reduce chunking or damage.',
            'Robust high-strength belt construction designed for multiple retreading and structural resilience.',
            'Straight groove architecture enhances wet traction and steering stability on roads.',
            'Optimized contact patch and tread design for long life and consistent performance across steer and drive axles .' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
