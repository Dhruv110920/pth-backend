        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="tr20.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">BOSS TR 20</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹10,194</span>
                    <span class="original-price" id="originalPrice">₹11,943.00</span>
                    <span class="discount-badge">8% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
                  The Ascenso Boss TR 20 is a robust tractor rear tyre designed for high traction and durability in agricultural operations. 
                   Its deep lugs and strong nylon casing ensure superior grip, stability, and load-bearing capacity even on tough terrains.
                  The self-cleaning tread design helps maintain performance in muddy fields, making it ideal for ploughing and fieldwork. Its sturdy construction also enhances resistance against wear and punctures.

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> Deep Lugs – Provides excellent traction and grip on soft and uneven agricultural surfaces. </li>
                        <li><i class="fas fa-check"></i> Strong Nylon Casing – Enhances durability and load-carrying capacity under heavy farm operations. </li>
                        <li><i class="fas fa-check"></i> Self-Cleaning Tread Design – Prevents mud and debris accumulation for consistent performance. </li>
                        <li><i class="fas fa-check"></i> Improved Sidewall Strength – Offers better resistance against cuts and impacts in rough field conditions.</li>
                        <li><i class="fas fa-check"></i> Long Tread Life – Designed to deliver extended service life, reducing replacement frequency and cost.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p> the Ascenso Boss TR 20 tyre comes with a manufacturer’s warranty that covers defects in material and workmanship for a specific period, typically up to 7 years from the date of manufacture. The warranty is applicable only under normal agricultural usage and when the tyre is used as per company guidelines. Damages due to improper use, overloading, or external factors are not covered. Customers can claim warranty through authorized Ascenso dealers or service centers across India.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '15',
        inventoryId: 15, // Links to inventory system tire ID
        name: 'BOSS TR 20',
        brand: 'Ascenso',
        price: 10194,
        originalPrice: 11943,
        category: 'high-performance',
        description: 'The Ascenso Boss TR 20 is a robust tractor rear tyre designed for high traction and durability in agricultural operations. Its deep lugs and strong nylon casing ensure superior grip, stability, and load-bearing capacity even on tough terrains. The self-cleaning tread design helps maintain performance in muddy fields, making it ideal for ploughing and fieldwork. Its sturdy construction also enhances resistance against wear and punctures.',
        features: [
            'Deep Lugs – Provides excellent traction and grip on soft and uneven agricultural surfaces.',
            'Strong Nylon Casing – Enhances durability and load-carrying capacity under heavy farm operations. ',
            'Self-Cleaning Tread Design – Prevents mud and debris accumulation for consistent performance.',
            'Improved Sidewall Strength – Offers better resistance against cuts and impacts in rough field conditions.',
            'Long Tread Life – Designed to deliver extended service life, reducing replacement frequency and cost.'
        ], 
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
