        ...
        <main>
            ...
            <section class="products-section" id="productsSection">
                ...
                <div class="products-grid" id="productsGrid">
                    ...
                    <!-- Product 1: Jet R Miles -->
<div class="product-card" data-id="58" data-redirect="jetR.php" data-name="Jet R Miles">
    <div class="product-image">
        <img src="Rmile.png" alt="Jet R Miles" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
        <div class="product-image-placeholder" style="display: none;">🛞</div>
    </div>
    <div class="product-brand">JK</div>
    <div class="product-name">Jet R Miles</div>
    <div class="product-specs">295/90 D20</div>
    <div class="product-price">₹14,492</div>
    <button class="add-to-cart-btn">Add to Cart</button>
</div>


                    <!-- Product 2: Jet R Xtra Miles -->
                    <div class="product-card" data-id="59" data-redirect="RX.php" data-name="Jet R Xtra Miles">
                        <div class="product-image">
                            <img src="Rxtra.png" alt="Jet R Xtra Miles" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">JK</div>
                        <div class="product-name">Jet R Xtra Miles</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹14,492</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 3: Jet Xtra XLM -->
                    <div class="product-card" data-id="60" data-redirect="X.php" data-name="Jet Xtra XLM">
                        <div class="product-image">
                            <img src="XLM.png" alt="Jet Xtra XLM" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">JK</div>
                        <div class="product-name">Jet Xtra XLM</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹16,016</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>

                    <!-- Product 4: Vikrant Trak LUG+ -->
                    <div class="product-card" data-id="61" data-redirect="LUG+.php" data-name="Vikrant Trak LUG+">
                        <div class="product-image">
                            <img src="lug+.png" alt="Vikrant Trak LUG+" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">JK</div>
                        <div class="product-name">Vikrant Trak LUG+</div>
                        <div class="product-specs">10.00-20</div>
                        <div class="product-price">₹13,906</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                    ...
                    <!-- Product 7: JDC XD -->
                    <div class="product-card" data-id="64" data-redirect="jdc.php" data-name="JDC XD">
                        <div class="product-image">
                            <img src="jdc.png" alt="JDC XD" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="product-image-placeholder" style="display: none;">🛞</div>
                        </div>
                        <div class="product-brand">JK</div>
                        <div class="product-name">JDC XD</div>
                        <div class="product-specs">295/90 R20</div>
                        <div class="product-price">₹19,418</div>
                        <button class="add-to-cart-btn">Add to Cart</button>
                    </div>
                </div>
            </section>
