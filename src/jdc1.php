        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="jdc.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">JDC XD</h1>
                ...
                <div class="product-price">
                    ...
                    <span class="original-price" id="originalPrice">₹20,389.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The JDC XD is a heavy-duty drive and dummy axle tyre tailored for tippers and hauling vehicles operating on rugged, on/off-road terrains. It features a silica-enhanced compound and self-cleaning lug grooves to resist cuts, chips, and debris, ensuring traction and durability in challenging conditions.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i>Silica-enriched tread compound offers enhanced resistance to cut-and-chip damage.</li>
                        <li><i class="fas fa-check"></i>Self-cleaning lug design clears debris automatically, maintaining grip in muddy or gravel terrain.</li>
                        <li><i class="fas fa-check"></i>Reinforced radial construction built for high load endurance and long service life.</li>
                        <li><i class="fas fa-check"></i>Optimized for low rolling resistance, improving fuel efficiency in high-stress use.</li>
                        <li><i class="fas fa-check"></i>Designed for drive/dummy axle duty, offering stability and reliability under heavy load.</li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>The JDC XD comes with JK Tyre’s 3-year warranty from invoice or manufacture date, valid for the original purchaser. It covers manufacturing defects such as casing faults or belt separations and is settled on a pro-rata basis depending on remaining tread. Damage from road hazards, wear beyond the TWI, or misuse is not covered. </p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '64',
        inventoryId: 64, // Links to inventory system tire ID
        name: 'JDC XD',
        brand: 'JK',
        price: 18945,
        originalPrice: 20389,
        category: 'high-performance',
        description: 'The JDC XD is a heavy-duty drive and dummy axle tyre tailored for tippers and hauling vehicles operating on rugged, on/off-road terrains. It features a silica-enhanced compound and self-cleaning lug grooves to resist cuts, chips, and debris, ensuring traction and durability in challenging conditions.',
        features: [
            'Silica-enriched tread compound offers enhanced resistance to cut-and-chip damage.',
            'Self-cleaning lug design clears debris automatically, maintaining grip in muddy or gravel terrain.',
            'Reinforced radial construction built for high load endurance and long service life.',
            'Optimized for low rolling resistance, improving fuel efficiency in high-stress use.',
            'Designed for drive/dummy axle duty, offering stability and reliability under heavy load.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
