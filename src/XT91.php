        ...
        <div class="product-content">
            ...
            <div class="product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" class="main-image" src="xt9.png" alt="Tire Image">
            ...
            <div class="product-details">
                <h1 class="product-title" id="productTitle">XT9 Gold-D</h1>
                ...
                <div class="product-price">
                    <span id="currentPrice">₹15,144</span>
                    <span class="original-price" id="originalPrice">₹15,804.00</span>
                    <span class="discount-badge">3% OFF</span>
                </div>

                <p class="product-description" id="productDescription">
            The Apollo XT‑9 Gold‑D is a premium drive tyre engineered for regional haul and logistics operations. It offers exceptional mileage and high retread potential thanks to its deep wavy lug tread and reinforced bias-ply construction. Designed for durability, fuel-efficiency, and stability across demanding routes.
                </p>

                <div class="product-features">
                    <h3><i class="fas fa-star"></i> Key Features</h3>
                    <ul class="features-list" id="featuresList">
                        <li><i class="fas fa-check"></i> High tread depth with reinforced compound ensures exceptional mileage and slow wear.</li>
                        <li><i class="fas fa-check"></i>Progressive groove design improves heat dissipation and enables stable handling at speed.</li>
                        <li><i class="fas fa-check"></i>Wavy lug tread configuration enhances traction and braking performance, especially on mixed surfaces. </li>
                        <li><i class="fas fa-check"></i> Superior casing durability supports multiple retread cycles, maximizing lifecycle value. </li>
                        <li><i class="fas fa-check"></i>Fuel-efficient behavior—rated highly for rolling resistance, helping reduce fuel consumption per journey. </li>
                    </ul>
                </div>

                <div class="warranty-info">
                    <h4><i class="fas fa-shield-alt"></i> Warranty Information</h4>
                    <p>Apollo provides a 2‑year manufacturer’s warranty for the XT‑9 Gold‑D, covering defects like radial splits (not caused by visible impact), ply or bead failure, and premature wear. Compensation is calculated on a pro‑rated basis relative to the remaining tread depth, contingent on inspection at authorized centers.</p>
                </div>
...
const products = {
    'michelin-pilot-sport': {
        id: '56',
        inventoryId: 56, // Links to inventory system tire ID
        name: 'XT9 Gold-D',
        brand: 'Apollo',
        price: 15144,
        originalPrice: 15804,
        category: 'high-performance',
        description: 'The Apollo XT‑9 Gold‑D is a premium drive tyre engineered for regional haul and logistics operations. It offers exceptional mileage and high retread potential thanks to its deep wavy lug tread and reinforced bias-ply construction. Designed for durability, fuel-efficiency, and stability across demanding routes.',
        features: [
            'High tread depth with reinforced compound ensures exceptional mileage and slow wear.',
            'Progressive groove design improves heat dissipation and enables stable handling at speed.',
            'Wavy lug tread configuration enhances traction and braking performance, especially on mixed surfaces. ',
            'Superior casing durability supports multiple retread cycles, maximizing lifecycle value. ',
            'Fuel-efficient behavior—rated highly for rolling resistance, helping reduce fuel consumption per journey.' 
        ],
        specifications: {
            loadIndex: '91-98',
            speedRating: 'W-Y',
